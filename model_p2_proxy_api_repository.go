...
// checks if the P2ProxyApiRepository type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &P2ProxyApiRepository{}

// P2ProxyApiRepository struct for P2ProxyApiRepository
type P2ProxyApiRepository struct {
...
type _P2ProxyApiRepository P2ProxyApiRepository
...
func (o P2ProxyApiRepository) MarshalJSON() ([]byte, error) {
...
func (o P2ProxyApiRepository) ToMap() (map[string]interface{}, error) {
...
func (o *P2ProxyApiRepository) UnmarshalJSON(data []byte) (err error) {
	...
	varP2ProxyApiRepository := _P2ProxyApiRepository{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varP2ProxyApiRepository)

	if err != nil {
		return err
	}

	*o = P2ProxyApiRepository(varP2ProxyApiRepository)

	return err
}

type NullableP2ProxyApiRepository struct {
	value *P2ProxyApiRepository
	isSet bool
}

func (v NullableP2ProxyApiRepository) Get() *P2ProxyApiRepository {
	return v.value
}

func (v *NullableP2ProxyApiRepository) Set(val *P2ProxyApiRepository) {
	v.value = val
	v.isSet = true
}

func (v NullableP2ProxyApiRepository) IsSet() bool {
	return v.isSet
}

func (v *NullableP2ProxyApiRepository) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableP2ProxyApiRepository(val *P2ProxyApiRepository) *NullableP2ProxyApiRepository {
	return &NullableP2ProxyApiRepository{value: val, isSet: true}
}

func (v NullableP2ProxyApiRepository) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableP2ProxyApiRepository) UnmarshalJSON(src []byte) error {
	v.isSet = true
