...
type ApiClearCache1Request struct {
	ctx context.Context
	ApiService *SecurityManagementLDAPAPIService
}

func (r ApiClearCache1Request) Execute() (*http.Response, error) {
	return r.ApiService.ClearCache1Execute(r)
}

/*
ClearCache1 Method for ClearCache1

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiClearCache1Request
*/
func (a *SecurityManagementLDAPAPIService) ClearCache1(ctx context.Context) ApiClearCache1Request {
	return ApiClearCache1Request{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *SecurityManagementLDAPAPIService) ClearCache1Execute(r ApiClearCache1Request) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SecurityManagementLDAPAPIService.ClearCache1")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiGetTemplatesRequest) Execute() ([]LdapSchemaTemplateXo, *http.Response, error) {
...
*/
func (a *SecurityManagementLDAPAPIService) GetTemplates(ctx context.Context) ApiGetTemplatesRequest {
	return ApiGetTemplatesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SecurityManagementLDAPAPIService) GetTemplatesExecute(r ApiGetTemplatesRequest) ([]LdapSchemaTemplateXo, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SecurityManagementLDAPAPIService.GetTemplates")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiVerifyConnection1Request) ExistingServerName(existingServerName string) ApiVerifyConnection1Request {
	r.existingServerName = &existingServerName
	return r
}

func (r ApiVerifyConnection1Request) Body(body CreateLdapServerXo) ApiVerifyConnection1Request {
	r.body = &body
	return r
}
...
/*
VerifyConnection1 Method for VerifyConnection1

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiVerifyConnection1Request
*/
func (a *SecurityManagementLDAPAPIService) VerifyConnection1(ctx context.Context) ApiVerifyConnection1Request {
	return ApiVerifyConnection1Request{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *SecurityManagementLDAPAPIService) VerifyConnection1Execute(r ApiVerifyConnection1Request) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SecurityManagementLDAPAPIService.VerifyConnection1")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiVerifyLoginRequest struct {
	ctx context.Context
	ApiService *SecurityManagementLDAPAPIService
	body *LdapVerifyLoginXo
}

func (r ApiVerifyLoginRequest) Body(body LdapVerifyLoginXo) ApiVerifyLoginRequest {
	r.body = &body
	return r
}

func (r ApiVerifyLoginRequest) Execute() (*http.Response, error) {
	return r.ApiService.VerifyLoginExecute(r)
}

/*
VerifyLogin Method for VerifyLogin

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiVerifyLoginRequest
*/
func (a *SecurityManagementLDAPAPIService) VerifyLogin(ctx context.Context) ApiVerifyLoginRequest {
	return ApiVerifyLoginRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *SecurityManagementLDAPAPIService) VerifyLoginExecute(r ApiVerifyLoginRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SecurityManagementLDAPAPIService.VerifyLogin")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiVerifyUserMappingRequest struct {
	ctx context.Context
	ApiService *SecurityManagementLDAPAPIService
	existingServerName *string
	body *CreateLdapServerXo
...
func (r ApiVerifyUserMappingRequest) ExistingServerName(existingServerName string) ApiVerifyUserMappingRequest {
	r.existingServerName = &existingServerName
	return r
}

func (r ApiVerifyUserMappingRequest) Body(body CreateLdapServerXo) ApiVerifyUserMappingRequest {
	r.body = &body
	return r
}

func (r ApiVerifyUserMappingRequest) Execute() ([]LdapTestUserMappingXo, *http.Response, error) {
	return r.ApiService.VerifyUserMappingExecute(r)
}

/*
VerifyUserMapping Method for VerifyUserMapping

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiVerifyUserMappingRequest
*/
func (a *SecurityManagementLDAPAPIService) VerifyUserMapping(ctx context.Context) ApiVerifyUserMappingRequest {
	return ApiVerifyUserMappingRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SecurityManagementLDAPAPIService) VerifyUserMappingExecute(r ApiVerifyUserMappingRequest) ([]LdapTestUserMappingXo, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SecurityManagementLDAPAPIService.VerifyUserMapping")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
