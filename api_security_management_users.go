...
func (r ApiGet4Request) Execute() (*UserTokenXO, *http.Response, error) {
	return r.ApiService.Get4Execute(r)
}

/*
Get4 Get user token metadata for the given user.
...
*/
func (a *SecurityManagementUsersAPIService) Get4(ctx context.Context, userId string, realm string) ApiGet4Request {
	return ApiGet4Request{
		ApiService: a,
		ctx: ctx,
		userId: userId,
...
// Execute executes the request
//  @return UserTokenXO
func (a *SecurityManagementUsersAPIService) Get4Execute(r ApiGet4Request) (*UserTokenXO, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SecurityManagementUsersAPIService.Get4")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
