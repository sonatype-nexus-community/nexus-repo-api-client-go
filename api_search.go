...
func (r ApiSearchRequest) AnsibleGalaxyNamespace(ansibleGalaxyNamespace string) ApiSearchRequest {
	r.ansibleGalaxyNamespace = &ansibleGalaxyNamespace
	return r
}

// ansible-galaxy name
func (r ApiSearchRequest) AnsibleGalaxyName(ansibleGalaxyName string) ApiSearchRequest {
	r.ansibleGalaxyName = &ansibleGalaxyName
	return r
}

// ansible-galaxy version
func (r ApiSearchRequest) AnsibleGalaxyVersion(ansibleGalaxyVersion string) ApiSearchRequest {
...
func (r ApiSearchRequest) PubAssetKind(pubAssetKind string) ApiSearchRequest {
...
// swift scope
func (r ApiSearchRequest) SwiftScope(swiftScope string) ApiSearchRequest {
	r.swiftScope = &swiftScope
	return r
}

// swift asset kind
func (r ApiSearchRequest) SwiftAssetKind(swiftAssetKind string) ApiSearchRequest {
...
// ansible-galaxy namespace
func (r ApiSearchAndDownloadAssetsRequest) AnsibleGalaxyNamespace(ansibleGalaxyNamespace string) ApiSearchAndDownloadAssetsRequest {
	r.ansibleGalaxyNamespace = &ansibleGalaxyNamespace
	return r
}

// ansible-galaxy name
func (r ApiSearchAndDownloadAssetsRequest) AnsibleGalaxyName(ansibleGalaxyName string) ApiSearchAndDownloadAssetsRequest {
	r.ansibleGalaxyName = &ansibleGalaxyName
	return r
}

// ansible-galaxy version
func (r ApiSearchAndDownloadAssetsRequest) AnsibleGalaxyVersion(ansibleGalaxyVersion string) ApiSearchAndDownloadAssetsRequest {
	r.ansibleGalaxyVersion = &ansibleGalaxyVersion
	return r
}
...
// Pub asset kind (PACKAGE, PACKAGE_METADATA, VERSION_METADATA, ADVISORIES)
func (r ApiSearchAndDownloadAssetsRequest) PubAssetKind(pubAssetKind string) ApiSearchAndDownloadAssetsRequest {
	r.pubAssetKind = &pubAssetKind
	return r
}
...
// swift scope
func (r ApiSearchAndDownloadAssetsRequest) SwiftScope(swiftScope string) ApiSearchAndDownloadAssetsRequest {
	r.swiftScope = &swiftScope
	return r
}

// swift asset kind
func (r ApiSearchAndDownloadAssetsRequest) SwiftAssetKind(swiftAssetKind string) ApiSearchAndDownloadAssetsRequest {
	r.swiftAssetKind = &swiftAssetKind
	return r
}
...
// ansible-galaxy namespace
func (r ApiSearchAssetsRequest) AnsibleGalaxyNamespace(ansibleGalaxyNamespace string) ApiSearchAssetsRequest {
	r.ansibleGalaxyNamespace = &ansibleGalaxyNamespace
	return r
}

// ansible-galaxy name
func (r ApiSearchAssetsRequest) AnsibleGalaxyName(ansibleGalaxyName string) ApiSearchAssetsRequest {
	r.ansibleGalaxyName = &ansibleGalaxyName
	return r
}

// ansible-galaxy version
func (r ApiSearchAssetsRequest) AnsibleGalaxyVersion(ansibleGalaxyVersion string) ApiSearchAssetsRequest {
	r.ansibleGalaxyVersion = &ansibleGalaxyVersion
	return r
}
...
// Pub asset kind (PACKAGE, PACKAGE_METADATA, VERSION_METADATA, ADVISORIES)
func (r ApiSearchAssetsRequest) PubAssetKind(pubAssetKind string) ApiSearchAssetsRequest {
	r.pubAssetKind = &pubAssetKind
	return r
}
...
// swift scope
func (r ApiSearchAssetsRequest) SwiftScope(swiftScope string) ApiSearchAssetsRequest {
	r.swiftScope = &swiftScope
	return r
}

// swift asset kind
func (r ApiSearchAssetsRequest) SwiftAssetKind(swiftAssetKind string) ApiSearchAssetsRequest {
	r.swiftAssetKind = &swiftAssetKind
	return r
}
...
func (r ApiSuggestRequest) Q(q string) ApiSuggestRequest {
	r.q = &q
	return r
}

// Filter by format (e.g., maven2, npm, pypi)
func (r ApiSuggestRequest) Format(format string) ApiSuggestRequest {
	r.format = &format
	return r
}
...
func (r ApiSuggestRequest) Execute() (*http.Response, error) {
	return r.ApiService.SuggestExecute(r)
}

/*
Suggest Get search suggestions for autocomplete
...
*/
func (a *SearchAPIService) Suggest(ctx context.Context) ApiSuggestRequest {
	return ApiSuggestRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *SearchAPIService) SuggestExecute(r ApiSuggestRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SearchAPIService.Suggest")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
