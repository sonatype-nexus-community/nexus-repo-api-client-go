...
type HuggingFaceProxyRepositoryApiRequest struct {
	...
	Xet *HuggingFaceXetAttributes `json:"xet,omitempty"`
}
...
// GetXet returns the Xet field value if set, zero value otherwise.
func (o *HuggingFaceProxyRepositoryApiRequest) GetXet() HuggingFaceXetAttributes {
	if o == nil || IsNil(o.Xet) {
		var ret HuggingFaceXetAttributes
		return ret
	}
	return *o.Xet
}

// GetXetOk returns a tuple with the Xet field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetXet gets a reference to the given HuggingFaceXetAttributes and assigns it to the Xet field.
