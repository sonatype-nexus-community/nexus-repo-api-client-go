...
// checks if the PubGroupApiRepository type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PubGroupApiRepository{}

// PubGroupApiRepository struct for PubGroupApiRepository
type PubGroupApiRepository struct {
...
type _PubGroupApiRepository PubGroupApiRepository
...
func (o PubGroupApiRepository) MarshalJSON() ([]byte, error) {
...
func (o PubGroupApiRepository) ToMap() (map[string]interface{}, error) {
...
func (o *PubGroupApiRepository) UnmarshalJSON(data []byte) (err error) {
	...
	varPubGroupApiRepository := _PubGroupApiRepository{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPubGroupApiRepository)

	if err != nil {
		return err
	}

	*o = PubGroupApiRepository(varPubGroupApiRepository)

	return err
}

type NullablePubGroupApiRepository struct {
	value *PubGroupApiRepository
	isSet bool
}

func (v NullablePubGroupApiRepository) Get() *PubGroupApiRepository {
	return v.value
}

func (v *NullablePubGroupApiRepository) Set(val *PubGroupApiRepository) {
	v.value = val
	v.isSet = true
}

func (v NullablePubGroupApiRepository) IsSet() bool {
	return v.isSet
}

func (v *NullablePubGroupApiRepository) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePubGroupApiRepository(val *PubGroupApiRepository) *NullablePubGroupApiRepository {
	return &NullablePubGroupApiRepository{value: val, isSet: true}
}

func (v NullablePubGroupApiRepository) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePubGroupApiRepository) UnmarshalJSON(src []byte) error {
	v.isSet = true
