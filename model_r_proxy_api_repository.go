...
// checks if the RProxyApiRepository type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RProxyApiRepository{}

// RProxyApiRepository struct for RProxyApiRepository
type RProxyApiRepository struct {
...
type _RProxyApiRepository RProxyApiRepository
...
func (o RProxyApiRepository) MarshalJSON() ([]byte, error) {
...
func (o RProxyApiRepository) ToMap() (map[string]interface{}, error) {
...
func (o *RProxyApiRepository) UnmarshalJSON(data []byte) (err error) {
	...
	varRProxyApiRepository := _RProxyApiRepository{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRProxyApiRepository)

	if err != nil {
		return err
	}

	*o = RProxyApiRepository(varRProxyApiRepository)

	return err
}

type NullableRProxyApiRepository struct {
	value *RProxyApiRepository
	isSet bool
}

func (v NullableRProxyApiRepository) Get() *RProxyApiRepository {
	return v.value
}

func (v *NullableRProxyApiRepository) Set(val *RProxyApiRepository) {
	v.value = val
	v.isSet = true
}

func (v NullableRProxyApiRepository) IsSet() bool {
	return v.isSet
}

func (v *NullableRProxyApiRepository) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRProxyApiRepository(val *RProxyApiRepository) *NullableRProxyApiRepository {
	return &NullableRProxyApiRepository{value: val, isSet: true}
}

func (v NullableRProxyApiRepository) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRProxyApiRepository) UnmarshalJSON(src []byte) error {
	v.isSet = true
