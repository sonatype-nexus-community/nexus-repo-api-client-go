...
type ApiCreateBlobStoreRequest struct {
	ctx context.Context
	ApiService *BlobStoreAPIService
	body *AzureBlobStoreApiModel
}

func (r ApiCreateBlobStoreRequest) Body(body AzureBlobStoreApiModel) ApiCreateBlobStoreRequest {
	r.body = &body
	return r
}

func (r ApiCreateBlobStoreRequest) Execute() (*http.Response, error) {
	return r.ApiService.CreateBlobStoreExecute(r)
}

/*
CreateBlobStore Create an Azure blob store

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiCreateBlobStoreRequest
*/
func (a *BlobStoreAPIService) CreateBlobStore(ctx context.Context) ApiCreateBlobStoreRequest {
	return ApiCreateBlobStoreRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *BlobStoreAPIService) CreateBlobStoreExecute(r ApiCreateBlobStoreRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BlobStoreAPIService.CreateBlobStore")
	if err != nil {
...
type ApiCreateBlobStore1Request struct {
	ctx context.Context
	ApiService *BlobStoreAPIService
	body *GoogleCloudBlobstoreApiModel
}

func (r ApiCreateBlobStore1Request) Body(body GoogleCloudBlobstoreApiModel) ApiCreateBlobStore1Request {
	r.body = &body
	return r
}
...
/*
CreateBlobStore1 Create a Google Cloud blob store
...
type ApiGetBlobStoreRequest struct {
	ctx context.Context
	ApiService *BlobStoreAPIService
	name string
}

func (r ApiGetBlobStoreRequest) Execute() (*AzureBlobStoreApiModel, *http.Response, error) {
	return r.ApiService.GetBlobStoreExecute(r)
}

/*
GetBlobStore Get an Azure blob store configuration by name

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param name Name of the blob store configuration to fetch
 @return ApiGetBlobStoreRequest
*/
func (a *BlobStoreAPIService) GetBlobStore(ctx context.Context, name string) ApiGetBlobStoreRequest {
	return ApiGetBlobStoreRequest{
		ApiService: a,
		ctx: ctx,
		name: name,
...
func (a *BlobStoreAPIService) GetBlobStoreExecute(r ApiGetBlobStoreRequest) (*AzureBlobStoreApiModel, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BlobStoreAPIService.GetBlobStore")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiGetBlobStore1Request) Execute() (*GoogleCloudBlobstoreApiModel, *http.Response, error) {
	return r.ApiService.GetBlobStore1Execute(r)
}

/*
GetBlobStore1 Get the configuration for a Google Cloud blob store
...
func (a *BlobStoreAPIService) GetBlobStore1Execute(r ApiGetBlobStore1Request) (*GoogleCloudBlobstoreApiModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiGetRegionsByProjectIdRequest struct {
	ctx context.Context
	ApiService *BlobStoreAPIService
	projectId string
}

func (r ApiGetRegionsByProjectIdRequest) Execute() ([]string, *http.Response, error) {
	return r.ApiService.GetRegionsByProjectIdExecute(r)
}
...
GetRegionsByProjectId Get the project regions by project's id
 ...
 @return ApiGetRegionsByProjectIdRequest
*/
func (a *BlobStoreAPIService) GetRegionsByProjectId(ctx context.Context, projectId string) ApiGetRegionsByProjectIdRequest {
	return ApiGetRegionsByProjectIdRequest{
		ApiService: a,
		ctx: ctx,
		projectId: projectId,
...
// Execute executes the request
//  @return []string
func (a *BlobStoreAPIService) GetRegionsByProjectIdExecute(r ApiGetRegionsByProjectIdRequest) ([]string, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BlobStoreAPIService.GetRegionsByProjectId")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiUpdateBlobStoreRequest struct {
	ctx context.Context
	ApiService *BlobStoreAPIService
	name string
	body *AzureBlobStoreApiModel
...
func (r ApiUpdateBlobStoreRequest) Body(body AzureBlobStoreApiModel) ApiUpdateBlobStoreRequest {
	r.body = &body
	return r
}

func (r ApiUpdateBlobStoreRequest) Execute() (*http.Response, error) {
	return r.ApiService.UpdateBlobStoreExecute(r)
}

/*
UpdateBlobStore Update an Azure blob store configuration by name

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param name Name of the blob store to update
 @return ApiUpdateBlobStoreRequest
*/
func (a *BlobStoreAPIService) UpdateBlobStore(ctx context.Context, name string) ApiUpdateBlobStoreRequest {
	return ApiUpdateBlobStoreRequest{
		ApiService: a,
		ctx: ctx,
		name: name,
...
// Execute executes the request
func (a *BlobStoreAPIService) UpdateBlobStoreExecute(r ApiUpdateBlobStoreRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BlobStoreAPIService.UpdateBlobStore")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiUpdateBlobStore1Request) Body(body GoogleCloudBlobstoreApiModel) ApiUpdateBlobStore1Request {
	r.body = &body
	return r
}
...
/*
UpdateBlobStore1 Update a Google Cloud blob store
