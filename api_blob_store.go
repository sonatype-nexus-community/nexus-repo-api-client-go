...
func (r ApiCreateBlobStoreRequest) Body(body S3BlobStoreApiModel) ApiCreateBlobStoreRequest {
	r.body = &body
	return r
}
...
/*
CreateBlobStore Create an S3 blob store
...
func (r ApiGetBlobStoreRequest) Execute() (*S3BlobStoreApiModel, *http.Response, error) {
	return r.ApiService.GetBlobStoreExecute(r)
}

/*
GetBlobStore Get a S3 blob store configuration by name
...
func (a *BlobStoreAPIService) GetBlobStoreExecute(r ApiGetBlobStoreRequest) (*S3BlobStoreApiModel, *http.Response, error) {
	var (
...
func (r ApiUpdateBlobStoreRequest) Body(body S3BlobStoreApiModel) ApiUpdateBlobStoreRequest {
	r.body = &body
	return r
}
...
/*
UpdateBlobStore Update an S3 blob store configuration by name
