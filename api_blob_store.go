...
type ApiCreateBlobStore2Request struct {
	ctx context.Context
	ApiService *BlobStoreAPIService
	body *GoogleCloudBlobstoreApiModel
}

func (r ApiCreateBlobStore2Request) Body(body GoogleCloudBlobstoreApiModel) ApiCreateBlobStore2Request {
	r.body = &body
	return r
}

func (r ApiCreateBlobStore2Request) Execute() (*http.Response, error) {
	return r.ApiService.CreateBlobStore2Execute(r)
}
...
CreateBlobStore2 Create a Google Cloud blob store
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiCreateBlobStore2Request
*/
func (a *BlobStoreAPIService) CreateBlobStore2(ctx context.Context) ApiCreateBlobStore2Request {
	return ApiCreateBlobStore2Request{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *BlobStoreAPIService) CreateBlobStore2Execute(r ApiCreateBlobStore2Request) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BlobStoreAPIService.CreateBlobStore2")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiGetBlobStore2Request struct {
	ctx context.Context
	ApiService *BlobStoreAPIService
	name string
}

func (r ApiGetBlobStore2Request) Execute() (*GoogleCloudBlobstoreApiModel, *http.Response, error) {
	return r.ApiService.GetBlobStore2Execute(r)
}
...
GetBlobStore2 Get the configuration for a Google Cloud blob store
 ...
 @return ApiGetBlobStore2Request
*/
func (a *BlobStoreAPIService) GetBlobStore2(ctx context.Context, name string) ApiGetBlobStore2Request {
	return ApiGetBlobStore2Request{
		ApiService: a,
		ctx: ctx,
		name: name,
...
func (a *BlobStoreAPIService) GetBlobStore2Execute(r ApiGetBlobStore2Request) (*GoogleCloudBlobstoreApiModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BlobStoreAPIService.GetBlobStore2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiUpdateBlobStore2Request struct {
	ctx context.Context
	ApiService *BlobStoreAPIService
	name string
	body *GoogleCloudBlobstoreApiModel
...
func (r ApiUpdateBlobStore2Request) Body(body GoogleCloudBlobstoreApiModel) ApiUpdateBlobStore2Request {
	r.body = &body
	return r
}

func (r ApiUpdateBlobStore2Request) Execute() (*http.Response, error) {
	return r.ApiService.UpdateBlobStore2Execute(r)
}
...
UpdateBlobStore2 Update a Google Cloud blob store
 ...
 @return ApiUpdateBlobStore2Request
*/
func (a *BlobStoreAPIService) UpdateBlobStore2(ctx context.Context, name string) ApiUpdateBlobStore2Request {
	return ApiUpdateBlobStore2Request{
		ApiService: a,
		ctx: ctx,
		name: name,
...
// Execute executes the request
func (a *BlobStoreAPIService) UpdateBlobStore2Execute(r ApiUpdateBlobStore2Request) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BlobStoreAPIService.UpdateBlobStore2")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
