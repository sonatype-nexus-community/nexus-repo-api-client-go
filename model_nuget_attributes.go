...
type NugetAttributes struct {
	// Allow unauthenticated access to the symbol server (required for debugger integration)
	AllowAnonymousSymbolAccess *bool `json:"allowAnonymousSymbolAccess,omitempty"`
	...
	// Optional upstream symbol server URL for proxy repositories
...
// GetAllowAnonymousSymbolAccess returns the AllowAnonymousSymbolAccess field value if set, zero value otherwise.
func (o *NugetAttributes) GetAllowAnonymousSymbolAccess() bool {
	if o == nil || IsNil(o.AllowAnonymousSymbolAccess) {
		var ret bool
		return ret
	}
	return *o.AllowAnonymousSymbolAccess
}

// GetAllowAnonymousSymbolAccessOk returns a tuple with the AllowAnonymousSymbolAccess field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NugetAttributes) GetAllowAnonymousSymbolAccessOk() (*bool, bool) {
	if o == nil || IsNil(o.AllowAnonymousSymbolAccess) {
		return nil, false
	}
	return o.AllowAnonymousSymbolAccess, true
}
...
// SetAllowAnonymousSymbolAccess gets a reference to the given bool and assigns it to the AllowAnonymousSymbolAccess field.
func (o *NugetAttributes) SetAllowAnonymousSymbolAccess(v bool) {
	o.AllowAnonymousSymbolAccess = &v
}
...
// GetSymbolServerUrl returns the SymbolServerUrl field value if set, zero value otherwise.
func (o *NugetAttributes) GetSymbolServerUrl() string {
	if o == nil || IsNil(o.SymbolServerUrl) {
		var ret string
		return ret
	}
	return *o.SymbolServerUrl
}

// GetSymbolServerUrlOk returns a tuple with the SymbolServerUrl field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NugetAttributes) GetSymbolServerUrlOk() (*string, bool) {
	if o == nil || IsNil(o.SymbolServerUrl) {
		return nil, false
	}
	return o.SymbolServerUrl, true
}
...
// SetSymbolServerUrl gets a reference to the given string and assigns it to the SymbolServerUrl field.
...
func (o NugetAttributes) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AllowAnonymousSymbolAccess) {
		toSerialize["allowAnonymousSymbolAccess"] = o.AllowAnonymousSymbolAccess
	}
	...
	if !IsNil(o.SymbolServerUrl) {
		toSerialize["symbolServerUrl"] = o.SymbolServerUrl
	}
