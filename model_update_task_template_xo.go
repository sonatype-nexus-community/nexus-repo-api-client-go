...
type UpdateTaskTemplateXO struct {
	...
	// Indicates whether the task can run concurrently with other instances of the same type.
	ConcurrentRun *bool `json:"concurrentRun,omitempty"`
	// Indicates if the task would be enabled.
	Enabled bool `json:"enabled"`
	// Metadata for each form field declared by the task descriptor, in the order the descriptor declares them. Populated on read responses; ignored on create/update.
	FormFields []FormFieldInfo `json:"formFields,omitempty"`
...
// GetConcurrentRun returns the ConcurrentRun field value if set, zero value otherwise.
func (o *UpdateTaskTemplateXO) GetConcurrentRun() bool {
	if o == nil || IsNil(o.ConcurrentRun) {
		var ret bool
		return ret
	}
	return *o.ConcurrentRun
}

// GetConcurrentRunOk returns a tuple with the ConcurrentRun field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpdateTaskTemplateXO) GetConcurrentRunOk() (*bool, bool) {
	if o == nil || IsNil(o.ConcurrentRun) {
		return nil, false
	}
	return o.ConcurrentRun, true
}
...
// SetConcurrentRun gets a reference to the given bool and assigns it to the ConcurrentRun field.
...
// SetFormFields gets a reference to the given []FormFieldInfo and assigns it to the FormFields field.
...
func (o UpdateTaskTemplateXO) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ConcurrentRun) {
		toSerialize["concurrentRun"] = o.ConcurrentRun
	}
