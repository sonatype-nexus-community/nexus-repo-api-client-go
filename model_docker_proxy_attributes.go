...
type DockerProxyAttributes struct {
	...
	EcrAuth *EcrAuthAttributes `json:"ecrAuth,omitempty"`
...
type _DockerProxyAttributes DockerProxyAttributes
...
// GetEcrAuth returns the EcrAuth field value if set, zero value otherwise.
func (o *DockerProxyAttributes) GetEcrAuth() EcrAuthAttributes {
	if o == nil || IsNil(o.EcrAuth) {
		var ret EcrAuthAttributes
		return ret
	}
	return *o.EcrAuth
}

// GetEcrAuthOk returns a tuple with the EcrAuth field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DockerProxyAttributes) GetEcrAuthOk() (*EcrAuthAttributes, bool) {
	if o == nil || IsNil(o.EcrAuth) {
		return nil, false
	}
	return o.EcrAuth, true
}
...
// SetEcrAuth gets a reference to the given EcrAuthAttributes and assigns it to the EcrAuth field.
...
func (o *DockerProxyAttributes) UnmarshalJSON(data []byte) (err error) {
	...
	varDockerProxyAttributes := _DockerProxyAttributes{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDockerProxyAttributes)

	if err != nil {
		return err
	}

	*o = DockerProxyAttributes(varDockerProxyAttributes)
