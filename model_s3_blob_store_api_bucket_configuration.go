...
// S3BlobStoreApiBucketConfiguration The S3 specific configuration details for the S3 object that'll contain the blob store.
type S3BlobStoreApiBucketConfiguration struct {
	...
	AdvancedConnection *S3BlobStoreApiAdvancedBucketConnection `json:"advancedConnection,omitempty"`
	...
	Security *S3BlobStoreApiBucketSecurity `json:"security,omitempty"`
}
...
// GetAdvancedConnection returns the AdvancedConnection field value if set, zero value otherwise.
func (o *S3BlobStoreApiBucketConfiguration) GetAdvancedConnection() S3BlobStoreApiAdvancedBucketConnection {
	if o == nil || IsNil(o.AdvancedConnection) {
		var ret S3BlobStoreApiAdvancedBucketConnection
		return ret
	}
	return *o.AdvancedConnection
}

// GetAdvancedConnectionOk returns a tuple with the AdvancedConnection field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *S3BlobStoreApiBucketConfiguration) GetAdvancedConnectionOk() (*S3BlobStoreApiAdvancedBucketConnection, bool) {
	if o == nil || IsNil(o.AdvancedConnection) {
		return nil, false
	}
	return o.AdvancedConnection, true
}
...
// SetAdvancedConnection gets a reference to the given S3BlobStoreApiAdvancedBucketConnection and assigns it to the AdvancedConnection field.
func (o *S3BlobStoreApiBucketConfiguration) SetAdvancedConnection(v S3BlobStoreApiAdvancedBucketConnection) {
	o.AdvancedConnection = &v
}
...
// SetSecurity gets a reference to the given S3BlobStoreApiBucketSecurity and assigns it to the Security field.
...
func (o S3BlobStoreApiBucketConfiguration) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AdvancedConnection) {
		toSerialize["advancedConnection"] = o.AdvancedConnection
	}
