...
// checks if the MavenGroupApiRepository type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MavenGroupApiRepository{}

// MavenGroupApiRepository struct for MavenGroupApiRepository
type MavenGroupApiRepository struct {
...
type _MavenGroupApiRepository MavenGroupApiRepository
...
func (o MavenGroupApiRepository) MarshalJSON() ([]byte, error) {
...
func (o MavenGroupApiRepository) ToMap() (map[string]interface{}, error) {
...
func (o *MavenGroupApiRepository) UnmarshalJSON(data []byte) (err error) {
	...
	varMavenGroupApiRepository := _MavenGroupApiRepository{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMavenGroupApiRepository)

	if err != nil {
		return err
	}

	*o = MavenGroupApiRepository(varMavenGroupApiRepository)

	return err
}

type NullableMavenGroupApiRepository struct {
	value *MavenGroupApiRepository
	isSet bool
}

func (v NullableMavenGroupApiRepository) Get() *MavenGroupApiRepository {
	return v.value
}

func (v *NullableMavenGroupApiRepository) Set(val *MavenGroupApiRepository) {
	v.value = val
	v.isSet = true
}

func (v NullableMavenGroupApiRepository) IsSet() bool {
	return v.isSet
}

func (v *NullableMavenGroupApiRepository) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMavenGroupApiRepository(val *MavenGroupApiRepository) *NullableMavenGroupApiRepository {
	return &NullableMavenGroupApiRepository{value: val, isSet: true}
}

func (v NullableMavenGroupApiRepository) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMavenGroupApiRepository) UnmarshalJSON(src []byte) error {
	v.isSet = true
