...
// checks if the ComposerProxyApiRepository type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ComposerProxyApiRepository{}

// ComposerProxyApiRepository struct for ComposerProxyApiRepository
type ComposerProxyApiRepository struct {
...
type _ComposerProxyApiRepository ComposerProxyApiRepository
...
func NewComposerProxyApiRepository(httpClient HttpClientAttributes, name string, negativeCache NegativeCacheAttributes, online bool, proxy ProxyAttributes, storage StorageAttributes, format string, type_ string, url string) *ComposerProxyApiRepository {
	this := ComposerProxyApiRepository{}
...
func (o ComposerProxyApiRepository) MarshalJSON() ([]byte, error) {
...
func (o ComposerProxyApiRepository) ToMap() (map[string]interface{}, error) {
...
func (o *ComposerProxyApiRepository) UnmarshalJSON(data []byte) (err error) {
	...
	varComposerProxyApiRepository := _ComposerProxyApiRepository{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varComposerProxyApiRepository)

	if err != nil {
		return err
	}

	*o = ComposerProxyApiRepository(varComposerProxyApiRepository)

	return err
}

type NullableComposerProxyApiRepository struct {
	value *ComposerProxyApiRepository
	isSet bool
}

func (v NullableComposerProxyApiRepository) Get() *ComposerProxyApiRepository {
	return v.value
}

func (v *NullableComposerProxyApiRepository) Set(val *ComposerProxyApiRepository) {
	v.value = val
	v.isSet = true
}

func (v NullableComposerProxyApiRepository) IsSet() bool {
	return v.isSet
}

func (v *NullableComposerProxyApiRepository) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComposerProxyApiRepository(val *ComposerProxyApiRepository) *NullableComposerProxyApiRepository {
	return &NullableComposerProxyApiRepository{value: val, isSet: true}
}

func (v NullableComposerProxyApiRepository) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComposerProxyApiRepository) UnmarshalJSON(src []byte) error {
	v.isSet = true
