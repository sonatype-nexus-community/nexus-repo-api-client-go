...
type ApiCreateBowerGroupRepositoryRequest struct {
	ctx context.Context
	ApiService *RepositoryManagementAPIService
	body *BowerGroupRepositoryApiRequest
}

func (r ApiCreateBowerGroupRepositoryRequest) Body(body BowerGroupRepositoryApiRequest) ApiCreateBowerGroupRepositoryRequest {
	r.body = &body
	return r
}

func (r ApiCreateBowerGroupRepositoryRequest) Execute() (*http.Response, error) {
	return r.ApiService.CreateBowerGroupRepositoryExecute(r)
}

/*
CreateBowerGroupRepository Create Bower group repository

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiCreateBowerGroupRepositoryRequest
*/
func (a *RepositoryManagementAPIService) CreateBowerGroupRepository(ctx context.Context) ApiCreateBowerGroupRepositoryRequest {
	return ApiCreateBowerGroupRepositoryRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *RepositoryManagementAPIService) CreateBowerGroupRepositoryExecute(r ApiCreateBowerGroupRepositoryRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RepositoryManagementAPIService.CreateBowerGroupRepository")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiCreateBowerHostedRepositoryRequest struct {
	ctx context.Context
	ApiService *RepositoryManagementAPIService
	body *BowerHostedRepositoryApiRequest
}

func (r ApiCreateBowerHostedRepositoryRequest) Body(body BowerHostedRepositoryApiRequest) ApiCreateBowerHostedRepositoryRequest {
	r.body = &body
	return r
}

func (r ApiCreateBowerHostedRepositoryRequest) Execute() (*http.Response, error) {
	return r.ApiService.CreateBowerHostedRepositoryExecute(r)
}

/*
CreateBowerHostedRepository Create Bower hosted repository

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiCreateBowerHostedRepositoryRequest
*/
func (a *RepositoryManagementAPIService) CreateBowerHostedRepository(ctx context.Context) ApiCreateBowerHostedRepositoryRequest {
	return ApiCreateBowerHostedRepositoryRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *RepositoryManagementAPIService) CreateBowerHostedRepositoryExecute(r ApiCreateBowerHostedRepositoryRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RepositoryManagementAPIService.CreateBowerHostedRepository")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiCreateBowerProxyRepositoryRequest struct {
	ctx context.Context
	ApiService *RepositoryManagementAPIService
	body *BowerProxyRepositoryApiRequest
}

func (r ApiCreateBowerProxyRepositoryRequest) Body(body BowerProxyRepositoryApiRequest) ApiCreateBowerProxyRepositoryRequest {
	r.body = &body
	return r
}

func (r ApiCreateBowerProxyRepositoryRequest) Execute() (*http.Response, error) {
	return r.ApiService.CreateBowerProxyRepositoryExecute(r)
}

/*
CreateBowerProxyRepository Create Bower proxy repository

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiCreateBowerProxyRepositoryRequest
*/
func (a *RepositoryManagementAPIService) CreateBowerProxyRepository(ctx context.Context) ApiCreateBowerProxyRepositoryRequest {
	return ApiCreateBowerProxyRepositoryRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *RepositoryManagementAPIService) CreateBowerProxyRepositoryExecute(r ApiCreateBowerProxyRepositoryRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RepositoryManagementAPIService.CreateBowerProxyRepository")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiGetBowerGroupRepositoryRequest struct {
	ctx context.Context
	ApiService *RepositoryManagementAPIService
	repositoryName string
}

func (r ApiGetBowerGroupRepositoryRequest) Execute() (*SimpleApiGroupRepository, *http.Response, error) {
	return r.ApiService.GetBowerGroupRepositoryExecute(r)
}

/*
GetBowerGroupRepository Get repository

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param repositoryName
 @return ApiGetBowerGroupRepositoryRequest
*/
func (a *RepositoryManagementAPIService) GetBowerGroupRepository(ctx context.Context, repositoryName string) ApiGetBowerGroupRepositoryRequest {
	return ApiGetBowerGroupRepositoryRequest{
		ApiService: a,
		ctx: ctx,
		repositoryName: repositoryName,
...
func (a *RepositoryManagementAPIService) GetBowerGroupRepositoryExecute(r ApiGetBowerGroupRepositoryRequest) (*SimpleApiGroupRepository, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RepositoryManagementAPIService.GetBowerGroupRepository")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiGetBowerHostedRepositoryRequest struct {
	ctx context.Context
	ApiService *RepositoryManagementAPIService
	repositoryName string
}

func (r ApiGetBowerHostedRepositoryRequest) Execute() (*SimpleApiHostedRepository, *http.Response, error) {
	return r.ApiService.GetBowerHostedRepositoryExecute(r)
}

/*
GetBowerHostedRepository Get repository

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param repositoryName
 @return ApiGetBowerHostedRepositoryRequest
*/
func (a *RepositoryManagementAPIService) GetBowerHostedRepository(ctx context.Context, repositoryName string) ApiGetBowerHostedRepositoryRequest {
	return ApiGetBowerHostedRepositoryRequest{
		ApiService: a,
		ctx: ctx,
		repositoryName: repositoryName,
...
func (a *RepositoryManagementAPIService) GetBowerHostedRepositoryExecute(r ApiGetBowerHostedRepositoryRequest) (*SimpleApiHostedRepository, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RepositoryManagementAPIService.GetBowerHostedRepository")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiGetBowerProxyRepositoryRequest struct {
	ctx context.Context
	ApiService *RepositoryManagementAPIService
	repositoryName string
}

func (r ApiGetBowerProxyRepositoryRequest) Execute() (*BowerProxyApiRepository, *http.Response, error) {
	return r.ApiService.GetBowerProxyRepositoryExecute(r)
}

/*
GetBowerProxyRepository Get repository

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param repositoryName
 @return ApiGetBowerProxyRepositoryRequest
*/
func (a *RepositoryManagementAPIService) GetBowerProxyRepository(ctx context.Context, repositoryName string) ApiGetBowerProxyRepositoryRequest {
	return ApiGetBowerProxyRepositoryRequest{
		ApiService: a,
		ctx: ctx,
		repositoryName: repositoryName,
...
func (a *RepositoryManagementAPIService) GetBowerProxyRepositoryExecute(r ApiGetBowerProxyRepositoryRequest) (*BowerProxyApiRepository, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RepositoryManagementAPIService.GetBowerProxyRepository")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiGetPypiProxyRepositoryRequest) Execute() (*SimpleApiProxyRepository, *http.Response, error) {
...
// Execute executes the request
//  @return SimpleApiProxyRepository
func (a *RepositoryManagementAPIService) GetPypiProxyRepositoryExecute(r ApiGetPypiProxyRepositoryRequest) (*SimpleApiProxyRepository, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiUpdateBowerGroupRepositoryRequest struct {
	ctx context.Context
	ApiService *RepositoryManagementAPIService
	repositoryName string
	body *BowerGroupRepositoryApiRequest
...
func (r ApiUpdateBowerGroupRepositoryRequest) Body(body BowerGroupRepositoryApiRequest) ApiUpdateBowerGroupRepositoryRequest {
	r.body = &body
	return r
}

func (r ApiUpdateBowerGroupRepositoryRequest) Execute() (*http.Response, error) {
	return r.ApiService.UpdateBowerGroupRepositoryExecute(r)
}

/*
UpdateBowerGroupRepository Update Bower group repository

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param repositoryName Name of the repository to update
 @return ApiUpdateBowerGroupRepositoryRequest
*/
func (a *RepositoryManagementAPIService) UpdateBowerGroupRepository(ctx context.Context, repositoryName string) ApiUpdateBowerGroupRepositoryRequest {
	return ApiUpdateBowerGroupRepositoryRequest{
		ApiService: a,
		ctx: ctx,
		repositoryName: repositoryName,
...
// Execute executes the request
func (a *RepositoryManagementAPIService) UpdateBowerGroupRepositoryExecute(r ApiUpdateBowerGroupRepositoryRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RepositoryManagementAPIService.UpdateBowerGroupRepository")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiUpdateBowerHostedRepositoryRequest struct {
	ctx context.Context
	ApiService *RepositoryManagementAPIService
	repositoryName string
	body *BowerHostedRepositoryApiRequest
...
func (r ApiUpdateBowerHostedRepositoryRequest) Body(body BowerHostedRepositoryApiRequest) ApiUpdateBowerHostedRepositoryRequest {
	r.body = &body
	return r
}

func (r ApiUpdateBowerHostedRepositoryRequest) Execute() (*http.Response, error) {
	return r.ApiService.UpdateBowerHostedRepositoryExecute(r)
}

/*
UpdateBowerHostedRepository Update Bower hosted repository

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param repositoryName Name of the repository to update
 @return ApiUpdateBowerHostedRepositoryRequest
*/
func (a *RepositoryManagementAPIService) UpdateBowerHostedRepository(ctx context.Context, repositoryName string) ApiUpdateBowerHostedRepositoryRequest {
	return ApiUpdateBowerHostedRepositoryRequest{
		ApiService: a,
		ctx: ctx,
		repositoryName: repositoryName,
...
// Execute executes the request
func (a *RepositoryManagementAPIService) UpdateBowerHostedRepositoryExecute(r ApiUpdateBowerHostedRepositoryRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RepositoryManagementAPIService.UpdateBowerHostedRepository")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiUpdateBowerProxyRepositoryRequest struct {
	ctx context.Context
	ApiService *RepositoryManagementAPIService
	repositoryName string
	body *BowerProxyRepositoryApiRequest
...
func (r ApiUpdateBowerProxyRepositoryRequest) Body(body BowerProxyRepositoryApiRequest) ApiUpdateBowerProxyRepositoryRequest {
	r.body = &body
	return r
}

func (r ApiUpdateBowerProxyRepositoryRequest) Execute() (*http.Response, error) {
	return r.ApiService.UpdateBowerProxyRepositoryExecute(r)
}

/*
UpdateBowerProxyRepository Update Bower proxy repository

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param repositoryName Name of the repository to update
 @return ApiUpdateBowerProxyRepositoryRequest
*/
func (a *RepositoryManagementAPIService) UpdateBowerProxyRepository(ctx context.Context, repositoryName string) ApiUpdateBowerProxyRepositoryRequest {
	return ApiUpdateBowerProxyRepositoryRequest{
		ApiService: a,
		ctx: ctx,
		repositoryName: repositoryName,
...
// Execute executes the request
func (a *RepositoryManagementAPIService) UpdateBowerProxyRepositoryExecute(r ApiUpdateBowerProxyRepositoryRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RepositoryManagementAPIService.UpdateBowerProxyRepository")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
