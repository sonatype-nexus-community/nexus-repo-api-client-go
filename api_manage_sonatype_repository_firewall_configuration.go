...
func (r ApiGetCapabilitiesRequest) Body(body IqConnectionXo) ApiGetCapabilitiesRequest {
	r.body = &body
	return r
}
...
/*
GetCapabilities Get IQ Server capabilities for a specific configuration
...
/*
GetCapabilities1 Get IQ Server capabilities (Firewall and Lifecycle)
