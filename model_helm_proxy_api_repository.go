...
// checks if the HelmProxyApiRepository type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HelmProxyApiRepository{}

// HelmProxyApiRepository struct for HelmProxyApiRepository
type HelmProxyApiRepository struct {
...
type _HelmProxyApiRepository HelmProxyApiRepository
...
func (o HelmProxyApiRepository) MarshalJSON() ([]byte, error) {
...
func (o HelmProxyApiRepository) ToMap() (map[string]interface{}, error) {
...
func (o *HelmProxyApiRepository) UnmarshalJSON(data []byte) (err error) {
	...
	varHelmProxyApiRepository := _HelmProxyApiRepository{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varHelmProxyApiRepository)

	if err != nil {
		return err
	}

	*o = HelmProxyApiRepository(varHelmProxyApiRepository)

	return err
}

type NullableHelmProxyApiRepository struct {
	value *HelmProxyApiRepository
	isSet bool
}

func (v NullableHelmProxyApiRepository) Get() *HelmProxyApiRepository {
	return v.value
}

func (v *NullableHelmProxyApiRepository) Set(val *HelmProxyApiRepository) {
	v.value = val
	v.isSet = true
}

func (v NullableHelmProxyApiRepository) IsSet() bool {
	return v.isSet
}

func (v *NullableHelmProxyApiRepository) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHelmProxyApiRepository(val *HelmProxyApiRepository) *NullableHelmProxyApiRepository {
	return &NullableHelmProxyApiRepository{value: val, isSet: true}
}

func (v NullableHelmProxyApiRepository) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHelmProxyApiRepository) UnmarshalJSON(src []byte) error {
	v.isSet = true
