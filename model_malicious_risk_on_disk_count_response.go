...
type MaliciousRiskOnDiskCountResponse struct {
	CountsByRepository *map[string]int64 `json:"countsByRepository,omitempty"`
...
// GetCountsByRepository returns the CountsByRepository field value if set, zero value otherwise.
func (o *MaliciousRiskOnDiskCountResponse) GetCountsByRepository() map[string]int64 {
	if o == nil || IsNil(o.CountsByRepository) {
		var ret map[string]int64
		return ret
	}
	return *o.CountsByRepository
}

// GetCountsByRepositoryOk returns a tuple with the CountsByRepository field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MaliciousRiskOnDiskCountResponse) GetCountsByRepositoryOk() (*map[string]int64, bool) {
	if o == nil || IsNil(o.CountsByRepository) {
		return nil, false
	}
	return o.CountsByRepository, true
}
...
// SetCountsByRepository gets a reference to the given map[string]int64 and assigns it to the CountsByRepository field.
func (o *MaliciousRiskOnDiskCountResponse) SetCountsByRepository(v map[string]int64) {
	o.CountsByRepository = &v
}
...
func (o MaliciousRiskOnDiskCountResponse) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.CountsByRepository) {
		toSerialize["countsByRepository"] = o.CountsByRepository
	}
