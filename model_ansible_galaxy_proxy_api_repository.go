...
// checks if the AnsibleGalaxyProxyApiRepository type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AnsibleGalaxyProxyApiRepository{}

// AnsibleGalaxyProxyApiRepository Ansible Galaxy proxy repository configuration
type AnsibleGalaxyProxyApiRepository struct {
...
type _AnsibleGalaxyProxyApiRepository AnsibleGalaxyProxyApiRepository
...
func NewAnsibleGalaxyProxyApiRepository(format string, httpClient HttpClientAttributes, name string, negativeCache NegativeCacheAttributes, online bool, proxy ProxyAttributes, storage StorageAttributes, type_ string) *AnsibleGalaxyProxyApiRepository {
	this := AnsibleGalaxyProxyApiRepository{}
	this.Format = format
...
func (o AnsibleGalaxyProxyApiRepository) MarshalJSON() ([]byte, error) {
...
func (o AnsibleGalaxyProxyApiRepository) ToMap() (map[string]interface{}, error) {
...
func (o *AnsibleGalaxyProxyApiRepository) UnmarshalJSON(data []byte) (err error) {
	...
	varAnsibleGalaxyProxyApiRepository := _AnsibleGalaxyProxyApiRepository{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAnsibleGalaxyProxyApiRepository)

	if err != nil {
		return err
	}

	*o = AnsibleGalaxyProxyApiRepository(varAnsibleGalaxyProxyApiRepository)

	return err
}

type NullableAnsibleGalaxyProxyApiRepository struct {
	value *AnsibleGalaxyProxyApiRepository
	isSet bool
}

func (v NullableAnsibleGalaxyProxyApiRepository) Get() *AnsibleGalaxyProxyApiRepository {
	return v.value
}

func (v *NullableAnsibleGalaxyProxyApiRepository) Set(val *AnsibleGalaxyProxyApiRepository) {
	v.value = val
	v.isSet = true
}

func (v NullableAnsibleGalaxyProxyApiRepository) IsSet() bool {
	return v.isSet
}

func (v *NullableAnsibleGalaxyProxyApiRepository) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAnsibleGalaxyProxyApiRepository(val *AnsibleGalaxyProxyApiRepository) *NullableAnsibleGalaxyProxyApiRepository {
	return &NullableAnsibleGalaxyProxyApiRepository{value: val, isSet: true}
}

func (v NullableAnsibleGalaxyProxyApiRepository) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAnsibleGalaxyProxyApiRepository) UnmarshalJSON(src []byte) error {
	v.isSet = true
