...
// checks if the AnsibleGalaxyProxyRepositoryApiRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AnsibleGalaxyProxyRepositoryApiRequest{}

// AnsibleGalaxyProxyRepositoryApiRequest Request body for creating or updating an Ansible Galaxy proxy repository
type AnsibleGalaxyProxyRepositoryApiRequest struct {
...
type _AnsibleGalaxyProxyRepositoryApiRequest AnsibleGalaxyProxyRepositoryApiRequest
...
func NewAnsibleGalaxyProxyRepositoryApiRequest(httpClient HttpClientAttributes, name string, negativeCache NegativeCacheAttributes, online bool, proxy ProxyAttributes, storage StorageAttributes) *AnsibleGalaxyProxyRepositoryApiRequest {
	this := AnsibleGalaxyProxyRepositoryApiRequest{}
...
func (o AnsibleGalaxyProxyRepositoryApiRequest) MarshalJSON() ([]byte, error) {
...
func (o AnsibleGalaxyProxyRepositoryApiRequest) ToMap() (map[string]interface{}, error) {
...
func (o *AnsibleGalaxyProxyRepositoryApiRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varAnsibleGalaxyProxyRepositoryApiRequest := _AnsibleGalaxyProxyRepositoryApiRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAnsibleGalaxyProxyRepositoryApiRequest)

	if err != nil {
		return err
	}

	*o = AnsibleGalaxyProxyRepositoryApiRequest(varAnsibleGalaxyProxyRepositoryApiRequest)

	return err
}

type NullableAnsibleGalaxyProxyRepositoryApiRequest struct {
	value *AnsibleGalaxyProxyRepositoryApiRequest
	isSet bool
}

func (v NullableAnsibleGalaxyProxyRepositoryApiRequest) Get() *AnsibleGalaxyProxyRepositoryApiRequest {
	return v.value
}

func (v *NullableAnsibleGalaxyProxyRepositoryApiRequest) Set(val *AnsibleGalaxyProxyRepositoryApiRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableAnsibleGalaxyProxyRepositoryApiRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableAnsibleGalaxyProxyRepositoryApiRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAnsibleGalaxyProxyRepositoryApiRequest(val *AnsibleGalaxyProxyRepositoryApiRequest) *NullableAnsibleGalaxyProxyRepositoryApiRequest {
	return &NullableAnsibleGalaxyProxyRepositoryApiRequest{value: val, isSet: true}
}

func (v NullableAnsibleGalaxyProxyRepositoryApiRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAnsibleGalaxyProxyRepositoryApiRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
