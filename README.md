...
*SecurityManagementUsersAPI* | [**Get4**](docs/SecurityManagementUsersAPI.md#get4) | **Get** /v1/security/users/{userId}/{realm}/user-token | Get user token metadata for the given user.
