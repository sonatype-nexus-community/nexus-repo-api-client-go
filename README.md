...
*CapabilitiesAPI* | [**List1**](docs/CapabilitiesAPI.md#list1) | **Get** /v1/capabilities | List the active capabilities
...
*DatabaseUpgradeAPI* | [**ClearResult**](docs/DatabaseUpgradeAPI.md#clearresult) | **Delete** /v1/clustered/upgrade-database-schema | Clears a stored database schema upgrade success or a recoverable error
*DatabaseUpgradeAPI* | [**GetProgress**](docs/DatabaseUpgradeAPI.md#getprogress) | **Get** /v1/clustered/upgrade-database-schema | Check the progress of a database schema upgrade
*DatabaseUpgradeAPI* | [**Migrate**](docs/DatabaseUpgradeAPI.md#migrate) | **Post** /v1/clustered/upgrade-database-schema | Begins a database schema upgrade
...
*SecurityManagementUserTokensAPI* | [**List**](docs/SecurityManagementUserTokensAPI.md#list) | **Get** /v1/security/user-tokens/tokens | List all user tokens
...
## Documentation For Models
 ...
 - [ApiClusterDatabaseMigrationResultDTO](docs/ApiClusterDatabaseMigrationResultDTO.md)
