...
*CapabilitiesAPI* | [**Create4**](docs/CapabilitiesAPI.md#create4) | **Post** /v1/capabilities | Create a capability
*CapabilitiesAPI* | [**Delete5**](docs/CapabilitiesAPI.md#delete5) | **Delete** /v1/capabilities/{capabilityId} | Delete a capability
*CapabilitiesAPI* | [**GetTypes**](docs/CapabilitiesAPI.md#gettypes) | **Get** /v1/capabilities/types | List all capability types available and exposed in the system
*CapabilitiesAPI* | [**List2**](docs/CapabilitiesAPI.md#list2) | **Get** /v1/capabilities | List the active capabilities
...
*InstanceConfigurationAPI* | [**ApplyConfiguration**](docs/InstanceConfigurationAPI.md#applyconfiguration) | **Put** /v1/configuration | Apply instance configuration
*InstanceConfigurationAPI* | [**ClearCipherPassword**](docs/InstanceConfigurationAPI.md#clearcipherpassword) | **Delete** /v1/configuration/cipher | Clear migration cipher password
*InstanceConfigurationAPI* | [**ExportConfiguration**](docs/InstanceConfigurationAPI.md#exportconfiguration) | **Get** /v1/configuration | Export instance configuration
*InstanceConfigurationAPI* | [**GetAssets1**](docs/InstanceConfigurationAPI.md#getassets1) | **Get** /v1/configuration/assets | List assets
*InstanceConfigurationAPI* | [**ImportAsset**](docs/InstanceConfigurationAPI.md#importasset) | **Post** /v1/configuration/assets/{repositoryName}/import | Import assets to repository
*InstanceConfigurationAPI* | [**SetCipherPassword**](docs/InstanceConfigurationAPI.md#setcipherpassword) | **Post** /v1/configuration/cipher | Set migration cipher password for decrypting imported secrets
*InstanceConfigurationAPI* | [**TransferComplete**](docs/InstanceConfigurationAPI.md#transfercomplete) | **Post** /v1/configuration/transfer-complete | Receive transfer complete notification from migrator
*InternalUIAPIPermissionsAPI* | [**List**](docs/InternalUIAPIPermissionsAPI.md#list) | **Get** /internal/ui/api/permissions | List REST endpoints with permission metadata for the API documentation UI
...
*MaliciousRiskOnDiskAPI* | [**AcknowledgeFinding**](docs/MaliciousRiskOnDiskAPI.md#acknowledgefinding) | **Post** /v1/malicious-risk/acknowledge/{id} | 
*MaliciousRiskOnDiskAPI* | [**DeleteFinding**](docs/MaliciousRiskOnDiskAPI.md#deletefinding) | **Post** /v1/malicious-risk/delete-finding/{id} | 
*MaliciousRiskOnDiskAPI* | [**GetActiveFindings**](docs/MaliciousRiskOnDiskAPI.md#getactivefindings) | **Get** /v1/malicious-risk/active-findings | 
...
*MaliciousRiskOnDiskAPI* | [**GetHistory**](docs/MaliciousRiskOnDiskAPI.md#gethistory) | **Get** /v1/malicious-risk/history | 
*MaliciousRiskOnDiskAPI* | [**GetMaliciousRiskComponents**](docs/MaliciousRiskOnDiskAPI.md#getmaliciousriskcomponents) | **Get** /v1/malicious-risk/components | List malicious components with asset IDs for removal
...
*MaliciousRiskOnDiskAPI* | [**RemediateFindings**](docs/MaliciousRiskOnDiskAPI.md#remediatefindings) | **Post** /v1/malicious-risk/remediate | 
...
*ManageSonatypeRepositoryFirewallConfigurationAPI* | [**GetCapabilities**](docs/ManageSonatypeRepositoryFirewallConfigurationAPI.md#getcapabilities) | **Get** /v1/iq/capabilities | Get IQ Server capabilities (Firewall and Lifecycle)
*ManageSonatypeRepositoryFirewallConfigurationAPI* | [**GetCapabilities1**](docs/ManageSonatypeRepositoryFirewallConfigurationAPI.md#getcapabilities1) | **Post** /v1/iq/capabilities/test | Get IQ Server capabilities for a specific configuration
*ManageSonatypeRepositoryFirewallConfigurationAPI* | [**GetConfiguration1**](docs/ManageSonatypeRepositoryFirewallConfigurationAPI.md#getconfiguration1) | **Get** /v1/iq | Get Sonatype Repository Firewall configuration
...
*ManageSonatypeRepositoryFirewallConfigurationAPI* | [**TestNewConnection**](docs/ManageSonatypeRepositoryFirewallConfigurationAPI.md#testnewconnection) | **Post** /v1/iq/test-new-connection | Test new Sonatype Repository Firewall connection
*ManageSonatypeRepositoryFirewallConfigurationAPI* | [**UpdateConfiguration1**](docs/ManageSonatypeRepositoryFirewallConfigurationAPI.md#updateconfiguration1) | **Put** /v1/iq | Update Sonatype Repository Firewall configuration
...
*RecoveryModeAPI* | [**DisableRecoveryMode**](docs/RecoveryModeAPI.md#disablerecoverymode) | **Delete** /v1/recovery-mode | Disables recovery mode
*RecoveryModeAPI* | [**EnableRecoveryMode**](docs/RecoveryModeAPI.md#enablerecoverymode) | **Post** /v1/recovery-mode | Enables recovery mode and cancels conflicting tasks if running
*RepositoryBrowseAPI* | [**DeleteFolder**](docs/RepositoryBrowseAPI.md#deletefolder) | **Delete** /v1/repositories/{repositoryName}/browse | Delete a folder and all its contents
...
*SearchAPI* | [**Suggest**](docs/SearchAPI.md#suggest) | **Get** /v1/search/suggest | Get search suggestions for autocomplete
...
*SecurityIPAllowListAPI* | [**AddEntry**](docs/SecurityIPAllowListAPI.md#addentry) | **Post** /v1/security/ip-allowlist/entries | Add a new entry to the IP Allow List
*SecurityIPAllowListAPI* | [**BrowseEntries**](docs/SecurityIPAllowListAPI.md#browseentries) | **Get** /v1/security/ip-allowlist/entries | Get paginated list of IP Allow List entries with optional search filter
*SecurityIPAllowListAPI* | [**BulkDelete**](docs/SecurityIPAllowListAPI.md#bulkdelete) | **Delete** /v1/security/ip-allowlist/entries/bulk | Remove one or more entries from the IP Allow List by ID
*SecurityIPAllowListAPI* | [**BulkUpload**](docs/SecurityIPAllowListAPI.md#bulkupload) | **Post** /v1/security/ip-allowlist/entries/bulk | Bulk upload entries from CSV content
*SecurityIPAllowListAPI* | [**ClearAllEntries**](docs/SecurityIPAllowListAPI.md#clearallentries) | **Delete** /v1/security/ip-allowlist/entries | Clear all entries from the IP Allow List
*SecurityIPAllowListAPI* | [**GetCurrentIp**](docs/SecurityIPAllowListAPI.md#getcurrentip) | **Get** /v1/security/ip-allowlist/current-ip | Get the current user&#39;s IP address and whether it is in the allow list
*SecurityIPAllowListAPI* | [**GetSettings**](docs/SecurityIPAllowListAPI.md#getsettings) | **Get** /v1/security/ip-allowlist | Get IP Allow List settings (mode, entry counts, max entries)
*SecurityIPAllowListAPI* | [**UpdateEntry**](docs/SecurityIPAllowListAPI.md#updateentry) | **Put** /v1/security/ip-allowlist/entries/{id} | Update an existing entry in the IP Allow List
*SecurityIPAllowListAPI* | [**UpdateMode**](docs/SecurityIPAllowListAPI.md#updatemode) | **Put** /v1/security/ip-allowlist/mode | Update the IP Allow List operational mode
...
*SecurityManagementAPIAccessAPI* | [**CheckAccess**](docs/SecurityManagementAPIAccessAPI.md#checkaccess) | **Post** /internal/ui/security/access-check | Check if a user or role has access to an API endpoint
...
*SecurityManagementApiKeysPrincipalsEncryptionAPI* | [**ReEncrypt**](docs/SecurityManagementApiKeysPrincipalsEncryptionAPI.md#reencrypt) | **Put** /v1/apikeys/encryption/re-encrypt | Re-encrypt api keys principals using the specified configuration
...
*SecurityManagementLDAPAPI* | [**ClearCache1**](docs/SecurityManagementLDAPAPI.md#clearcache1) | **Delete** /v1/security/ldap/cache | 
...
*SecurityManagementLDAPAPI* | [**GetTemplates**](docs/SecurityManagementLDAPAPI.md#gettemplates) | **Get** /v1/security/ldap/templates | 
...
*SecurityManagementLDAPAPI* | [**VerifyConnection1**](docs/SecurityManagementLDAPAPI.md#verifyconnection1) | **Post** /v1/security/ldap/verify-connection | 
*SecurityManagementLDAPAPI* | [**VerifyLogin**](docs/SecurityManagementLDAPAPI.md#verifylogin) | **Post** /v1/security/ldap/verify-login | 
*SecurityManagementLDAPAPI* | [**VerifyUserMapping**](docs/SecurityManagementLDAPAPI.md#verifyusermapping) | **Post** /v1/security/ldap/verify-user-mapping | 
...
*SecurityManagementSAMLUsersAPI* | [**CreateUser1**](docs/SecurityManagementSAMLUsersAPI.md#createuser1) | **Post** /v1/security/saml/users | Create a new SAML user. This allows administrators to pre-create SAML users with roles before their first login.
*SecurityManagementSAMLUsersAPI* | [**DeleteUser1**](docs/SecurityManagementSAMLUsersAPI.md#deleteuser1) | **Delete** /v1/security/saml/users/{userId} | Delete a SAML user.
*SecurityManagementSAMLUsersAPI* | [**GetUser**](docs/SecurityManagementSAMLUsersAPI.md#getuser) | **Get** /v1/security/saml/users/{userId} | Retrieve a SAML user by userId.
*SecurityManagementSAMLUsersAPI* | [**GetUsers1**](docs/SecurityManagementSAMLUsersAPI.md#getusers1) | **Get** /v1/security/saml/users | Retrieve a list of SAML users. The response is limited to 1,000 users.
*SecurityManagementSAMLUsersAPI* | [**UpdateUser1**](docs/SecurityManagementSAMLUsersAPI.md#updateuser1) | **Put** /v1/security/saml/users/{userId} | Update a SAML user&#39;s roles and attributes.
*SecurityManagementSSRFProtectionAPI* | [**GetConfiguration**](docs/SecurityManagementSSRFProtectionAPI.md#getconfiguration) | **Get** /v1/security/ssrf-protection | Get SSRF protection settings
*SecurityManagementSSRFProtectionAPI* | [**UpdateConfiguration**](docs/SecurityManagementSSRFProtectionAPI.md#updateconfiguration) | **Put** /v1/security/ssrf-protection | Update SSRF protection settings
*SecurityManagementSecretsEncryptionAPI* | [**ReEncrypt1**](docs/SecurityManagementSecretsEncryptionAPI.md#reencrypt1) | **Put** /v1/secrets/encryption/re-encrypt | Re-encrypt secrets using the specified key
*SecurityManagementUserTokensAPI* | [**List1**](docs/SecurityManagementUserTokensAPI.md#list1) | **Get** /v1/security/user-tokens/tokens | List user tokens or look up a token owner by namecode
*SecurityManagementUserTokensAPI* | [**ResetAllUserTokens**](docs/SecurityManagementUserTokensAPI.md#resetallusertokens) | **Delete** /v1/security/user-tokens | 
...
*SecurityManagementUserTokensAPI* | [**SetServiceStatus**](docs/SecurityManagementUserTokensAPI.md#setservicestatus) | **Put** /v1/security/user-tokens | 
...
*SecurityManagementUsersAPI* | [**Create3**](docs/SecurityManagementUsersAPI.md#create3) | **Post** /v1/security/users/{userId}/{realm}/user-token | Create a user token for the given user.
...
*SecurityManagementUsersAPI* | [**Delete4**](docs/SecurityManagementUsersAPI.md#delete4) | **Delete** /v1/security/users/{userId}/{realm}/user-token | Delete the user token for the given user.
...
*SecurityManagementUsersAPI* | [**Get3**](docs/SecurityManagementUsersAPI.md#get3) | **Get** /v1/security/users/{userId}/{realm}/user-token | Get user token metadata for the given user.
*SecurityManagementUsersAPI* | [**GetUsers**](docs/SecurityManagementUsersAPI.md#getusers) | **Get** /v1/security/users | Retrieve a list of users. For SAML user sources a limit of 1000 users will be applied.
...
*TagsAPI* | [**Get2**](docs/TagsAPI.md#get2) | **Get** /v1/tags/{name} | Get a tag
...
*UsageHistoryAPI* | [**GetUsageHistory**](docs/UsageHistoryAPI.md#getusagehistory) | **Get** /v1/usage-history | Get usage history for sparklines
...
## Documentation For Models
 ...
 - [LicensedSolution](docs/LicensedSolution.md)
 - [MaliciousRiskComponentXO](docs/MaliciousRiskComponentXO.md)
 ...
 - [RemediateRequestXO](docs/RemediateRequestXO.md)
