...
func (r ApiCreate2Request) Body(body CleanupPolicyResourceXO) ApiCreate2Request {
	r.body = &body
	return r
}
...
/*
Create2 Create a new policy

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiCreate2Request
*/
func (a *CleanupPoliciesAPIService) Create2(ctx context.Context) ApiCreate2Request {
	return ApiCreate2Request{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *CleanupPoliciesAPIService) Create2Execute(r ApiCreate2Request) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CleanupPoliciesAPIService.Create2")
	if err != nil {
