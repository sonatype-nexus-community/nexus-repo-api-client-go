...
func Test_sonatyperepo_TagsAPIService(t *testing.T) {
	...
	t.Run("Test TagsAPIService Create1", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		httpRes, err := apiClient.TagsAPI.Create1(context.Background()).Execute()
	...
	t.Run("Test TagsAPIService Delete2", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var name string

		httpRes, err := apiClient.TagsAPI.Delete2(context.Background(), name).Execute()
