...
func Test_v395_TagsAPIService(t *testing.T) {
	...
	t.Run("Test TagsAPIService CreateTags", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.TagsAPI.CreateTags(context.Background()).Execute()
	...
	t.Run("Test TagsAPIService GetTags", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.TagsAPI.GetTags(context.Background(), name).Execute()
	...
	t.Run("Test TagsAPIService UpdateTags", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.TagsAPI.UpdateTags(context.Background(), name).Execute()
