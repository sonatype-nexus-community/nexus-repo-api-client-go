...
func Test_v395_SystemNodesAPIService(t *testing.T) {
	...
	t.Run("Test SystemNodesAPIService ListSystemInformation", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.SystemNodesAPI.ListSystemInformation(context.Background()).Execute()
	...
	t.Run("Test SystemNodesAPIService ListSystemNode", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.SystemNodesAPI.ListSystemNode(context.Background()).Execute()
