...
func Test_v395_SecurityManagementSAMLAPIService(t *testing.T) {
	...
	t.Run("Test SecurityManagementSAMLAPIService ListSecuritySaml", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.SecurityManagementSAMLAPI.ListSecuritySaml(context.Background()).Execute()
	...
	t.Run("Test SecurityManagementSAMLAPIService ListSecuritySamlMetadata", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.SecurityManagementSAMLAPI.ListSecuritySamlMetadata(context.Background()).Execute()
	...
	t.Run("Test SecurityManagementSAMLAPIService ListSecuritySamlPem", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.SecurityManagementSAMLAPI.ListSecuritySamlPem(context.Background()).Execute()
