...
func Test_v395_SecurityAtlassianCrowdAPIService(t *testing.T) {
	...
	t.Run("Test SecurityAtlassianCrowdAPIService ListSecurityAtlassianCrowd", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.SecurityAtlassianCrowdAPI.ListSecurityAtlassianCrowd(context.Background()).Execute()
	...
	t.Run("Test SecurityAtlassianCrowdAPIService UpdateSecurityAtlassianCrowd", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.SecurityAtlassianCrowdAPI.UpdateSecurityAtlassianCrowd(context.Background()).Execute()
