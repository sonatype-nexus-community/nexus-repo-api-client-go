...
func Test_v395_SecurityCertificatesAPIService(t *testing.T) {
	...
	t.Run("Test SecurityCertificatesAPIService ListSecuritySsl", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.SecurityCertificatesAPI.ListSecuritySsl(context.Background()).Execute()
	...
	t.Run("Test SecurityCertificatesAPIService ListSecuritySslTruststore", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.SecurityCertificatesAPI.ListSecuritySslTruststore(context.Background()).Execute()
