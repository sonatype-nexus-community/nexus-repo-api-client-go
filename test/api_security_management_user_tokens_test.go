...
func Test_v395_SecurityManagementUserTokensAPIService(t *testing.T) {
	...
	t.Run("Test SecurityManagementUserTokensAPIService ListSecurityUserTokensTokens", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.SecurityManagementUserTokensAPI.ListSecurityUserTokensTokens(context.Background()).Execute()
