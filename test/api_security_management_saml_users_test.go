...
func Test_v395_SecurityManagementSAMLUsersAPIService(t *testing.T) {
	...
	t.Run("Test SecurityManagementSAMLUsersAPIService GetSecuritySamlUsers", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.SecurityManagementSAMLUsersAPI.GetSecuritySamlUsers(context.Background(), userId).Execute()
	...
	t.Run("Test SecurityManagementSAMLUsersAPIService ListSecuritySamlUsers", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.SecurityManagementSAMLUsersAPI.ListSecuritySamlUsers(context.Background()).Execute()
