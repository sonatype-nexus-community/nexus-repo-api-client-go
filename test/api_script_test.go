...
func Test_v395_ScriptAPIService(t *testing.T) {
	...
	t.Run("Test ScriptAPIService CreateScriptRun", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.ScriptAPI.CreateScriptRun(context.Background(), name).Execute()
	...
	t.Run("Test ScriptAPIService GetScript", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.ScriptAPI.GetScript(context.Background(), name).Execute()
