...
func Test_v395_SecurityManagementUsersAPIService(t *testing.T) {
	...
	t.Run("Test SecurityManagementUsersAPIService CreateSecurityUsers", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.SecurityManagementUsersAPI.CreateSecurityUsers(context.Background()).Execute()
	...
	t.Run("Test SecurityManagementUsersAPIService ListSecurityUsers", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.SecurityManagementUsersAPI.ListSecurityUsers(context.Background()).Execute()
