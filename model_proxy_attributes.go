...
// GetPreserveEncodedCharacters returns the PreserveEncodedCharacters field value if set, zero value otherwise.
func (o *ProxyAttributes) GetPreserveEncodedCharacters() bool {
	if o == nil || IsNil(o.PreserveEncodedCharacters) {
		var ret bool
		return ret
	}
	return *o.PreserveEncodedCharacters
}

// GetPreserveEncodedCharactersOk returns a tuple with the PreserveEncodedCharacters field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ProxyAttributes) GetPreserveEncodedCharactersOk() (*bool, bool) {
	if o == nil || IsNil(o.PreserveEncodedCharacters) {
		return nil, false
	}
	return o.PreserveEncodedCharacters, true
}
...
// SetPreserveEncodedCharacters gets a reference to the given bool and assigns it to the PreserveEncodedCharacters field.
func (o *ProxyAttributes) SetPreserveEncodedCharacters(v bool) {
	o.PreserveEncodedCharacters = &v
}
...
func (o ProxyAttributes) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.PreserveEncodedCharacters) {
		toSerialize["preserveEncodedCharacters"] = o.PreserveEncodedCharacters
	}
