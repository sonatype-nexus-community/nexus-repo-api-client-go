...
// checks if the CondaProxyApiRepository type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CondaProxyApiRepository{}

// CondaProxyApiRepository struct for CondaProxyApiRepository
type CondaProxyApiRepository struct {
...
type _CondaProxyApiRepository CondaProxyApiRepository
...
func (o CondaProxyApiRepository) MarshalJSON() ([]byte, error) {
...
func (o CondaProxyApiRepository) ToMap() (map[string]interface{}, error) {
...
func (o *CondaProxyApiRepository) UnmarshalJSON(data []byte) (err error) {
	...
	varCondaProxyApiRepository := _CondaProxyApiRepository{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCondaProxyApiRepository)

	if err != nil {
		return err
	}

	*o = CondaProxyApiRepository(varCondaProxyApiRepository)

	return err
}

type NullableCondaProxyApiRepository struct {
	value *CondaProxyApiRepository
	isSet bool
}

func (v NullableCondaProxyApiRepository) Get() *CondaProxyApiRepository {
	return v.value
}

func (v *NullableCondaProxyApiRepository) Set(val *CondaProxyApiRepository) {
	v.value = val
	v.isSet = true
}

func (v NullableCondaProxyApiRepository) IsSet() bool {
	return v.isSet
}

func (v *NullableCondaProxyApiRepository) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCondaProxyApiRepository(val *CondaProxyApiRepository) *NullableCondaProxyApiRepository {
	return &NullableCondaProxyApiRepository{value: val, isSet: true}
}

func (v NullableCondaProxyApiRepository) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCondaProxyApiRepository) UnmarshalJSON(src []byte) error {
	v.isSet = true
