...
type MavenAttributes struct {
	...
	LayoutPolicy *string `json:"layoutPolicy,omitempty" validate:"regexp=STRICT|PERMISSIVE"`
	// What type of artifacts does this repository store?
	VersionPolicy *string `json:"versionPolicy,omitempty" validate:"regexp=RELEASE|SNAPSHOT|MIXED"`
}
