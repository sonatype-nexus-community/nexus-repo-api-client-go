...
func (r ApiAssociateRequest) AnsibleGalaxyNamespace(ansibleGalaxyNamespace string) ApiAssociateRequest {
	r.ansibleGalaxyNamespace = &ansibleGalaxyNamespace
	return r
}

// ansible-galaxy name
func (r ApiAssociateRequest) AnsibleGalaxyName(ansibleGalaxyName string) ApiAssociateRequest {
	r.ansibleGalaxyName = &ansibleGalaxyName
	return r
}

// ansible-galaxy version
func (r ApiAssociateRequest) AnsibleGalaxyVersion(ansibleGalaxyVersion string) ApiAssociateRequest {
...
func (r ApiAssociateRequest) PubAssetKind(pubAssetKind string) ApiAssociateRequest {
...
// swift scope
func (r ApiAssociateRequest) SwiftScope(swiftScope string) ApiAssociateRequest {
	r.swiftScope = &swiftScope
	return r
}

// swift asset kind
func (r ApiAssociateRequest) SwiftAssetKind(swiftAssetKind string) ApiAssociateRequest {
...
// ansible-galaxy namespace
func (r ApiDisassociateRequest) AnsibleGalaxyNamespace(ansibleGalaxyNamespace string) ApiDisassociateRequest {
	r.ansibleGalaxyNamespace = &ansibleGalaxyNamespace
	return r
}

// ansible-galaxy name
func (r ApiDisassociateRequest) AnsibleGalaxyName(ansibleGalaxyName string) ApiDisassociateRequest {
	r.ansibleGalaxyName = &ansibleGalaxyName
	return r
}

// ansible-galaxy version
func (r ApiDisassociateRequest) AnsibleGalaxyVersion(ansibleGalaxyVersion string) ApiDisassociateRequest {
	r.ansibleGalaxyVersion = &ansibleGalaxyVersion
	return r
}
...
// Pub asset kind (PACKAGE, PACKAGE_METADATA, VERSION_METADATA, ADVISORIES)
func (r ApiDisassociateRequest) PubAssetKind(pubAssetKind string) ApiDisassociateRequest {
	r.pubAssetKind = &pubAssetKind
	return r
}
...
// swift scope
func (r ApiDisassociateRequest) SwiftScope(swiftScope string) ApiDisassociateRequest {
	r.swiftScope = &swiftScope
	return r
}

// swift asset kind
func (r ApiDisassociateRequest) SwiftAssetKind(swiftAssetKind string) ApiDisassociateRequest {
	r.swiftAssetKind = &swiftAssetKind
	return r
}
...
func (r ApiGet2Request) Execute() (*TagXO, *http.Response, error) {
...
*/
func (a *TagsAPIService) Get2(ctx context.Context, name string) ApiGet2Request {
	return ApiGet2Request{
		ApiService: a,
		ctx: ctx,
		name: name,
...
// Execute executes the request
//  @return TagXO
func (a *TagsAPIService) Get2Execute(r ApiGet2Request) (*TagXO, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TagsAPIService.Get2")
	if err != nil {
