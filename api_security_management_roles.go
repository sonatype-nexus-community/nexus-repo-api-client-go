...
// A role configuration
func (r ApiUpdateRequest) Body(body RoleXORequest) ApiUpdateRequest {
	r.body = &body
	return r
}
...
*/
func (a *SecurityManagementRolesAPIService) Update(ctx context.Context, id string) ApiUpdateRequest {
	return ApiUpdateRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
func (a *SecurityManagementRolesAPIService) UpdateExecute(r ApiUpdateRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SecurityManagementRolesAPIService.Update")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
