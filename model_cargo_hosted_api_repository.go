...
// checks if the CargoHostedApiRepository type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CargoHostedApiRepository{}

// CargoHostedApiRepository struct for CargoHostedApiRepository
type CargoHostedApiRepository struct {
...
type _CargoHostedApiRepository CargoHostedApiRepository
...
func (o CargoHostedApiRepository) MarshalJSON() ([]byte, error) {
...
func (o CargoHostedApiRepository) ToMap() (map[string]interface{}, error) {
...
func (o *CargoHostedApiRepository) UnmarshalJSON(data []byte) (err error) {
	...
	varCargoHostedApiRepository := _CargoHostedApiRepository{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCargoHostedApiRepository)

	if err != nil {
		return err
	}

	*o = CargoHostedApiRepository(varCargoHostedApiRepository)

	return err
}

type NullableCargoHostedApiRepository struct {
	value *CargoHostedApiRepository
	isSet bool
}

func (v NullableCargoHostedApiRepository) Get() *CargoHostedApiRepository {
	return v.value
}

func (v *NullableCargoHostedApiRepository) Set(val *CargoHostedApiRepository) {
	v.value = val
	v.isSet = true
}

func (v NullableCargoHostedApiRepository) IsSet() bool {
	return v.isSet
}

func (v *NullableCargoHostedApiRepository) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCargoHostedApiRepository(val *CargoHostedApiRepository) *NullableCargoHostedApiRepository {
	return &NullableCargoHostedApiRepository{value: val, isSet: true}
}

func (v NullableCargoHostedApiRepository) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCargoHostedApiRepository) UnmarshalJSON(src []byte) error {
	v.isSet = true
