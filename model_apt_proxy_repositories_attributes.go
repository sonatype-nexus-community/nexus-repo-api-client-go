...
type AptProxyRepositoriesAttributes struct {
	// Distribution name. When enforceDistribution is false (default), this field is optional and informational only - proxy repositories forward all distribution requests to upstream transparently. When enforceDistribution is true, this field is required and restricts requests to only the specified distribution.
	Distribution *string `json:"distribution,omitempty"`
	// Whether to restrict requests to only the specified distribution
	EnforceDistribution *bool `json:"enforceDistribution,omitempty"`
	// Whether the upstream repository uses a flat structure (without distribution subdirectories). Set to true for flat repositories, false for standard hierarchical repositories.
	Flat bool `json:"flat"`
}
...
// GetEnforceDistribution returns the EnforceDistribution field value if set, zero value otherwise.
func (o *AptProxyRepositoriesAttributes) GetEnforceDistribution() bool {
	if o == nil || IsNil(o.EnforceDistribution) {
		var ret bool
		return ret
	}
	return *o.EnforceDistribution
}

// GetEnforceDistributionOk returns a tuple with the EnforceDistribution field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AptProxyRepositoriesAttributes) GetEnforceDistributionOk() (*bool, bool) {
	if o == nil || IsNil(o.EnforceDistribution) {
		return nil, false
	}
	return o.EnforceDistribution, true
}
...
// SetEnforceDistribution gets a reference to the given bool and assigns it to the EnforceDistribution field.
func (o *AptProxyRepositoriesAttributes) SetEnforceDistribution(v bool) {
	o.EnforceDistribution = &v
}
...
func (o AptProxyRepositoriesAttributes) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.EnforceDistribution) {
		toSerialize["enforceDistribution"] = o.EnforceDistribution
	}
