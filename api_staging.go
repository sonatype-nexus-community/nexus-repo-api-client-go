...
func (r ApiDelete2Request) AnsibleGalaxyNamespace(ansibleGalaxyNamespace string) ApiDelete2Request {
	r.ansibleGalaxyNamespace = &ansibleGalaxyNamespace
	return r
}

// ansible-galaxy name
func (r ApiDelete2Request) AnsibleGalaxyName(ansibleGalaxyName string) ApiDelete2Request {
	r.ansibleGalaxyName = &ansibleGalaxyName
	return r
}

// ansible-galaxy version
func (r ApiDelete2Request) AnsibleGalaxyVersion(ansibleGalaxyVersion string) ApiDelete2Request {
...
func (r ApiDelete2Request) PubAssetKind(pubAssetKind string) ApiDelete2Request {
...
// swift scope
func (r ApiDelete2Request) SwiftScope(swiftScope string) ApiDelete2Request {
	r.swiftScope = &swiftScope
	return r
}

// swift asset kind
func (r ApiDelete2Request) SwiftAssetKind(swiftAssetKind string) ApiDelete2Request {
...
// ansible-galaxy namespace
func (r ApiMoveRequest) AnsibleGalaxyNamespace(ansibleGalaxyNamespace string) ApiMoveRequest {
	r.ansibleGalaxyNamespace = &ansibleGalaxyNamespace
	return r
}

// ansible-galaxy name
func (r ApiMoveRequest) AnsibleGalaxyName(ansibleGalaxyName string) ApiMoveRequest {
	r.ansibleGalaxyName = &ansibleGalaxyName
	return r
}

// ansible-galaxy version
func (r ApiMoveRequest) AnsibleGalaxyVersion(ansibleGalaxyVersion string) ApiMoveRequest {
	r.ansibleGalaxyVersion = &ansibleGalaxyVersion
	return r
}
...
// Pub asset kind (PACKAGE, PACKAGE_METADATA, VERSION_METADATA, ADVISORIES)
func (r ApiMoveRequest) PubAssetKind(pubAssetKind string) ApiMoveRequest {
	r.pubAssetKind = &pubAssetKind
	return r
}
...
// swift scope
func (r ApiMoveRequest) SwiftScope(swiftScope string) ApiMoveRequest {
	r.swiftScope = &swiftScope
	return r
}

// swift asset kind
func (r ApiMoveRequest) SwiftAssetKind(swiftAssetKind string) ApiMoveRequest {
	r.swiftAssetKind = &swiftAssetKind
	return r
}
