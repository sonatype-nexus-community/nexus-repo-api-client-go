...
func (r ApiDelete3Request) ConanBaseVersionStrict(conanBaseVersionStrict string) ApiDelete3Request {
	r.conanBaseVersionStrict = &conanBaseVersionStrict
	return r
}

// Return latest revision
func (r ApiDelete3Request) ConanRevisionLatest(conanRevisionLatest string) ApiDelete3Request {
	r.conanRevisionLatest = &conanRevisionLatest
	return r
}

// Conan arch
func (r ApiDelete3Request) ConanSettingsArch(conanSettingsArch string) ApiDelete3Request {
	r.conanSettingsArch = &conanSettingsArch
	return r
}

// Conan os
func (r ApiDelete3Request) ConanSettingsOs(conanSettingsOs string) ApiDelete3Request {
	r.conanSettingsOs = &conanSettingsOs
	return r
}

// Conan compiler
func (r ApiDelete3Request) ConanSettingsCompiler(conanSettingsCompiler string) ApiDelete3Request {
	r.conanSettingsCompiler = &conanSettingsCompiler
	return r
}

// Conan compiler version
func (r ApiDelete3Request) ConanSettingsCompilerVersion(conanSettingsCompilerVersion string) ApiDelete3Request {
	r.conanSettingsCompilerVersion = &conanSettingsCompilerVersion
	return r
}

// Conan compiler runtime
func (r ApiDelete3Request) ConanSettingsCompilerRuntime(conanSettingsCompilerRuntime string) ApiDelete3Request {
