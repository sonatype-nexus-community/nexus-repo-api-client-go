...
// terraform system
func (r ApiDelete2Request) TerraformSystem(terraformSystem string) ApiDelete2Request {
	r.terraformSystem = &terraformSystem
	return r
}

// terraform architecture
func (r ApiDelete2Request) TerraformArchitecture(terraformArchitecture string) ApiDelete2Request {
	r.terraformArchitecture = &terraformArchitecture
	return r
}

// terraform asset kind
func (r ApiDelete2Request) TerraformAssetKind(terraformAssetKind string) ApiDelete2Request {
...
// terraform system
func (r ApiMoveRequest) TerraformSystem(terraformSystem string) ApiMoveRequest {
	r.terraformSystem = &terraformSystem
	return r
}

// terraform architecture
func (r ApiMoveRequest) TerraformArchitecture(terraformArchitecture string) ApiMoveRequest {
	r.terraformArchitecture = &terraformArchitecture
	return r
}

// terraform asset kind
func (r ApiMoveRequest) TerraformAssetKind(terraformAssetKind string) ApiMoveRequest {
	r.terraformAssetKind = &terraformAssetKind
	return r
}
