...
func (r ApiDelete2Request) ConanBaseVersionStrict(conanBaseVersionStrict string) ApiDelete2Request {
	r.conanBaseVersionStrict = &conanBaseVersionStrict
	return r
}

// Return latest revision
func (r ApiDelete2Request) ConanRevisionLatest(conanRevisionLatest string) ApiDelete2Request {
	r.conanRevisionLatest = &conanRevisionLatest
	return r
}

// Conan arch
func (r ApiDelete2Request) ConanSettingsArch(conanSettingsArch string) ApiDelete2Request {
	r.conanSettingsArch = &conanSettingsArch
	return r
}

// Conan os
func (r ApiDelete2Request) ConanSettingsOs(conanSettingsOs string) ApiDelete2Request {
	r.conanSettingsOs = &conanSettingsOs
	return r
}

// Conan compiler
func (r ApiDelete2Request) ConanSettingsCompiler(conanSettingsCompiler string) ApiDelete2Request {
	r.conanSettingsCompiler = &conanSettingsCompiler
	return r
}

// Conan compiler version
func (r ApiDelete2Request) ConanSettingsCompilerVersion(conanSettingsCompilerVersion string) ApiDelete2Request {
	r.conanSettingsCompilerVersion = &conanSettingsCompilerVersion
	return r
}

// Conan compiler runtime
func (r ApiDelete2Request) ConanSettingsCompilerRuntime(conanSettingsCompilerRuntime string) ApiDelete2Request {
...
// Conan base version strict
func (r ApiMoveRequest) ConanBaseVersionStrict(conanBaseVersionStrict string) ApiMoveRequest {
	r.conanBaseVersionStrict = &conanBaseVersionStrict
	return r
}

// Return latest revision
func (r ApiMoveRequest) ConanRevisionLatest(conanRevisionLatest string) ApiMoveRequest {
	r.conanRevisionLatest = &conanRevisionLatest
	return r
}

// Conan arch
func (r ApiMoveRequest) ConanSettingsArch(conanSettingsArch string) ApiMoveRequest {
	r.conanSettingsArch = &conanSettingsArch
	return r
}

// Conan os
func (r ApiMoveRequest) ConanSettingsOs(conanSettingsOs string) ApiMoveRequest {
	r.conanSettingsOs = &conanSettingsOs
	return r
}

// Conan compiler
func (r ApiMoveRequest) ConanSettingsCompiler(conanSettingsCompiler string) ApiMoveRequest {
	r.conanSettingsCompiler = &conanSettingsCompiler
	return r
}

// Conan compiler version
func (r ApiMoveRequest) ConanSettingsCompilerVersion(conanSettingsCompilerVersion string) ApiMoveRequest {
	r.conanSettingsCompilerVersion = &conanSettingsCompilerVersion
	return r
}

// Conan compiler runtime
func (r ApiMoveRequest) ConanSettingsCompilerRuntime(conanSettingsCompilerRuntime string) ApiMoveRequest {
	r.conanSettingsCompilerRuntime = &conanSettingsCompilerRuntime
	return r
}
