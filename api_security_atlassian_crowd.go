...
func (r ApiVerifyConnection1Request) Body(body CrowdApiXO) ApiVerifyConnection1Request {
	r.body = &body
	return r
}
...
/*
VerifyConnection1 Verify connection using supplied Atlassian Crowd settings

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiVerifyConnection1Request
*/
func (a *SecurityAtlassianCrowdAPIService) VerifyConnection1(ctx context.Context) ApiVerifyConnection1Request {
	return ApiVerifyConnection1Request{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *SecurityAtlassianCrowdAPIService) VerifyConnection1Execute(r ApiVerifyConnection1Request) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SecurityAtlassianCrowdAPIService.VerifyConnection1")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
