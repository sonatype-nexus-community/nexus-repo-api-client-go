...
// GoogleCloudBlobStoreApiBucketConfiguration The GC Storage specific configuration details for the GC Storage object that'll contain the blob store.
type GoogleCloudBlobStoreApiBucketConfiguration struct {
	...
	Security *GoogleCloudBlobStoreApiBucketAuthentication `json:"security,omitempty"`
}
...
// SetSecurity gets a reference to the given GoogleCloudBlobStoreApiBucketAuthentication and assigns it to the Security field.
