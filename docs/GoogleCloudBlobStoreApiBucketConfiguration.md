...
**Security** | Pointer to [**GoogleCloudBlobStoreApiBucketAuthentication**](GoogleCloudBlobStoreApiBucketAuthentication.md) |  | [optional] 
...
`func (o *GoogleCloudBlobStoreApiBucketConfiguration) GetSecurity() GoogleCloudBlobStoreApiBucketAuthentication`

GetSecurity returns the Security field if non-nil, zero value otherwise.

### GetSecurityOk

`func (o *GoogleCloudBlobStoreApiBucketConfiguration) GetSecurityOk() (*GoogleCloudBlobStoreApiBucketAuthentication, bool)`
...
`func (o *GoogleCloudBlobStoreApiBucketConfiguration) SetSecurity(v GoogleCloudBlobStoreApiBucketAuthentication)`

SetSecurity sets Security field to given value.

### HasSecurity

`func (o *GoogleCloudBlobStoreApiBucketConfiguration) HasSecurity() bool`
