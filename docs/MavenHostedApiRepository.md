...
`func NewMavenHostedApiRepository(maven MavenAttributes, name string, online bool, storage HostedStorageAttributes, format string, type_ string, url string, ) *MavenHostedApiRepository`
