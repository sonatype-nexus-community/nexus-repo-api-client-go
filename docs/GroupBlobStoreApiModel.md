...
`func (o *GroupBlobStoreApiModel) GetSoftQuotaAttributes() BlobStoreConfiguration`

GetSoftQuotaAttributes returns the SoftQuotaAttributes field if non-nil, zero value otherwise.

### GetSoftQuotaAttributesOk

`func (o *GroupBlobStoreApiModel) GetSoftQuotaAttributesOk() (*BlobStoreConfiguration, bool)`
...
`func (o *GroupBlobStoreApiModel) SetSoftQuotaAttributes(v BlobStoreConfiguration)`

SetSoftQuotaAttributes sets SoftQuotaAttributes field to given value.

### HasSoftQuotaAttributes

`func (o *GroupBlobStoreApiModel) HasSoftQuotaAttributes() bool`
