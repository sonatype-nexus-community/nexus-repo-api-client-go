...
// go Module
func (r ApiUploadComponentRequest) GoModule(goModule string) ApiUploadComponentRequest {
	r.goModule = &goModule
	return r
}
...
func (a *ComponentsAPIService) UploadComponentExecute(r ApiUploadComponentRequest) (*http.Response, error) {
	...
	if r.goModule != nil {
		parameterAddToHeaderOrQuery(localVarFormParams, "go.module", r.goModule, "", "")
	}
	if r.goTag != nil {
