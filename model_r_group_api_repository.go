...
// checks if the RGroupApiRepository type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RGroupApiRepository{}

// RGroupApiRepository struct for RGroupApiRepository
type RGroupApiRepository struct {
...
type _RGroupApiRepository RGroupApiRepository
...
func (o RGroupApiRepository) MarshalJSON() ([]byte, error) {
...
func (o RGroupApiRepository) ToMap() (map[string]interface{}, error) {
...
func (o *RGroupApiRepository) UnmarshalJSON(data []byte) (err error) {
	...
	varRGroupApiRepository := _RGroupApiRepository{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRGroupApiRepository)

	if err != nil {
		return err
	}

	*o = RGroupApiRepository(varRGroupApiRepository)

	return err
}

type NullableRGroupApiRepository struct {
	value *RGroupApiRepository
	isSet bool
}

func (v NullableRGroupApiRepository) Get() *RGroupApiRepository {
	return v.value
}

func (v *NullableRGroupApiRepository) Set(val *RGroupApiRepository) {
	v.value = val
	v.isSet = true
}

func (v NullableRGroupApiRepository) IsSet() bool {
	return v.isSet
}

func (v *NullableRGroupApiRepository) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRGroupApiRepository(val *RGroupApiRepository) *NullableRGroupApiRepository {
	return &NullableRGroupApiRepository{value: val, isSet: true}
}

func (v NullableRGroupApiRepository) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRGroupApiRepository) UnmarshalJSON(src []byte) error {
	v.isSet = true
