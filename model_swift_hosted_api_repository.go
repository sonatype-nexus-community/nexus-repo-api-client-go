...
// checks if the SwiftHostedApiRepository type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SwiftHostedApiRepository{}

// SwiftHostedApiRepository struct for SwiftHostedApiRepository
type SwiftHostedApiRepository struct {
...
type _SwiftHostedApiRepository SwiftHostedApiRepository
...
func (o SwiftHostedApiRepository) MarshalJSON() ([]byte, error) {
...
func (o SwiftHostedApiRepository) ToMap() (map[string]interface{}, error) {
...
func (o *SwiftHostedApiRepository) UnmarshalJSON(data []byte) (err error) {
	...
	varSwiftHostedApiRepository := _SwiftHostedApiRepository{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSwiftHostedApiRepository)

	if err != nil {
		return err
	}

	*o = SwiftHostedApiRepository(varSwiftHostedApiRepository)

	return err
}

type NullableSwiftHostedApiRepository struct {
	value *SwiftHostedApiRepository
	isSet bool
}

func (v NullableSwiftHostedApiRepository) Get() *SwiftHostedApiRepository {
	return v.value
}

func (v *NullableSwiftHostedApiRepository) Set(val *SwiftHostedApiRepository) {
	v.value = val
	v.isSet = true
}

func (v NullableSwiftHostedApiRepository) IsSet() bool {
	return v.isSet
}

func (v *NullableSwiftHostedApiRepository) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSwiftHostedApiRepository(val *SwiftHostedApiRepository) *NullableSwiftHostedApiRepository {
	return &NullableSwiftHostedApiRepository{value: val, isSet: true}
}

func (v NullableSwiftHostedApiRepository) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSwiftHostedApiRepository) UnmarshalJSON(src []byte) error {
	v.isSet = true
