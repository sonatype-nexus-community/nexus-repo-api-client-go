...
type UpdateLdapServerXo struct {
	...
	UserEmailAddressAttribute string `json:"userEmailAddressAttribute"`
	...
	UserRealNameAttribute string `json:"userRealNameAttribute"`
...
// GetUserEmailAddressAttribute returns the UserEmailAddressAttribute field value
...
// GetUserEmailAddressAttributeOk returns a tuple with the UserEmailAddressAttribute field value
// and a boolean to check if the value has been set.
...
// SetUserEmailAddressAttribute sets field value
...
// GetUserRealNameAttribute returns the UserRealNameAttribute field value
...
// GetUserRealNameAttributeOk returns a tuple with the UserRealNameAttribute field value
// and a boolean to check if the value has been set.
...
// SetUserRealNameAttribute sets field value
