...
type _GroupBlobStoreApiCreateRequest GroupBlobStoreApiCreateRequest
...
func (o *GroupBlobStoreApiCreateRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varGroupBlobStoreApiCreateRequest := _GroupBlobStoreApiCreateRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGroupBlobStoreApiCreateRequest)

	if err != nil {
		return err
	}

	*o = GroupBlobStoreApiCreateRequest(varGroupBlobStoreApiCreateRequest)
