...
type TerraformProxyRepositoryApiRequest struct {
	...
	HttpClient *HttpClientAttributesWithPreemptiveAuth `json:"httpClient,omitempty"`
...
// GetHttpClient returns the HttpClient field value if set, zero value otherwise.
func (o *TerraformProxyRepositoryApiRequest) GetHttpClient() HttpClientAttributesWithPreemptiveAuth {
	if o == nil || IsNil(o.HttpClient) {
...
// GetHttpClientOk returns a tuple with the HttpClient field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetHttpClient gets a reference to the given HttpClientAttributesWithPreemptiveAuth and assigns it to the HttpClient field.
