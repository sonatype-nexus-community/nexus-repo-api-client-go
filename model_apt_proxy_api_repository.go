...
type AptProxyApiRepository struct {
	...
	AptSigning *AptSigningRepositoriesAttributes `json:"aptSigning,omitempty"`
...
// GetAptSigning returns the AptSigning field value if set, zero value otherwise.
func (o *AptProxyApiRepository) GetAptSigning() AptSigningRepositoriesAttributes {
	if o == nil || IsNil(o.AptSigning) {
...
// GetAptSigningOk returns a tuple with the AptSigning field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetAptSigning gets a reference to the given AptSigningRepositoriesAttributes and assigns it to the AptSigning field.
