...
// checks if the ConanHostedApiRepository type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConanHostedApiRepository{}

// ConanHostedApiRepository struct for ConanHostedApiRepository
type ConanHostedApiRepository struct {
...
type _ConanHostedApiRepository ConanHostedApiRepository
...
func (o ConanHostedApiRepository) MarshalJSON() ([]byte, error) {
...
func (o ConanHostedApiRepository) ToMap() (map[string]interface{}, error) {
...
func (o *ConanHostedApiRepository) UnmarshalJSON(data []byte) (err error) {
	...
	varConanHostedApiRepository := _ConanHostedApiRepository{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varConanHostedApiRepository)

	if err != nil {
		return err
	}

	*o = ConanHostedApiRepository(varConanHostedApiRepository)

	return err
}

type NullableConanHostedApiRepository struct {
	value *ConanHostedApiRepository
	isSet bool
}

func (v NullableConanHostedApiRepository) Get() *ConanHostedApiRepository {
	return v.value
}

func (v *NullableConanHostedApiRepository) Set(val *ConanHostedApiRepository) {
	v.value = val
	v.isSet = true
}

func (v NullableConanHostedApiRepository) IsSet() bool {
	return v.isSet
}

func (v *NullableConanHostedApiRepository) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConanHostedApiRepository(val *ConanHostedApiRepository) *NullableConanHostedApiRepository {
	return &NullableConanHostedApiRepository{value: val, isSet: true}
}

func (v NullableConanHostedApiRepository) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConanHostedApiRepository) UnmarshalJSON(src []byte) error {
	v.isSet = true
