...
type _HttpClientConnectionAuthenticationAttributes HttpClientConnectionAuthenticationAttributes
...
func (o *HttpClientConnectionAuthenticationAttributes) UnmarshalJSON(data []byte) (err error) {
	...
	varHttpClientConnectionAuthenticationAttributes := _HttpClientConnectionAuthenticationAttributes{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varHttpClientConnectionAuthenticationAttributes)

	if err != nil {
		return err
	}

	*o = HttpClientConnectionAuthenticationAttributes(varHttpClientConnectionAuthenticationAttributes)
