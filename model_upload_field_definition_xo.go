...
type UploadFieldDefinitionXO struct {
	...
	GroupHelpText *string `json:"groupHelpText,omitempty"`
...
// GetGroupHelpText returns the GroupHelpText field value if set, zero value otherwise.
func (o *UploadFieldDefinitionXO) GetGroupHelpText() string {
	if o == nil || IsNil(o.GroupHelpText) {
		var ret string
		return ret
	}
	return *o.GroupHelpText
}

// GetGroupHelpTextOk returns a tuple with the GroupHelpText field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UploadFieldDefinitionXO) GetGroupHelpTextOk() (*string, bool) {
	if o == nil || IsNil(o.GroupHelpText) {
		return nil, false
	}
	return o.GroupHelpText, true
}
...
// SetGroupHelpText gets a reference to the given string and assigns it to the GroupHelpText field.
...
func (o UploadFieldDefinitionXO) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.GroupHelpText) {
		toSerialize["groupHelpText"] = o.GroupHelpText
	}
	if !IsNil(o.Name) {
