...
type AssetXO struct {
	...
	BlobUpdated *time.Time `json:"blobUpdated,omitempty"`
...
// GetBlobRef returns the BlobRef field value if set, zero value otherwise.
func (o *AssetXO) GetBlobRef() string {
	if o == nil || IsNil(o.BlobRef) {
		var ret string
		return ret
	}
	return *o.BlobRef
...
// GetBlobRefOk returns a tuple with the BlobRef field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AssetXO) GetBlobRefOk() (*string, bool) {
	if o == nil || IsNil(o.BlobRef) {
		return nil, false
	}
	return o.BlobRef, true
}
...
// SetBlobRef gets a reference to the given string and assigns it to the BlobRef field.
...
// GetBlobUpdated returns the BlobUpdated field value if set, zero value otherwise.
func (o *AssetXO) GetBlobUpdated() time.Time {
	if o == nil || IsNil(o.BlobUpdated) {
		var ret time.Time
		return ret
	}
	return *o.BlobUpdated
}

// GetBlobUpdatedOk returns a tuple with the BlobUpdated field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AssetXO) GetBlobUpdatedOk() (*time.Time, bool) {
	if o == nil || IsNil(o.BlobUpdated) {
		return nil, false
	}
	return o.BlobUpdated, true
}
...
// SetBlobUpdated gets a reference to the given time.Time and assigns it to the BlobUpdated field.
...
func (o AssetXO) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.BlobRef) {
		toSerialize["blobRef"] = o.BlobRef
	}
	if !IsNil(o.BlobStoreName) {
		toSerialize["blobStoreName"] = o.BlobStoreName
	}
	if !IsNil(o.BlobUpdated) {
		toSerialize["blobUpdated"] = o.BlobUpdated
	}
	if !IsNil(o.Checksum) {
