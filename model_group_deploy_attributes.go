...
type _GroupDeployAttributes GroupDeployAttributes
...
func (o *GroupDeployAttributes) UnmarshalJSON(data []byte) (err error) {
	...
	varGroupDeployAttributes := _GroupDeployAttributes{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGroupDeployAttributes)

	if err != nil {
		return err
	}

	*o = GroupDeployAttributes(varGroupDeployAttributes)
