...
type _ApiPrivilegeRepositoryContentSelectorRequest ApiPrivilegeRepositoryContentSelectorRequest
...
func (o *ApiPrivilegeRepositoryContentSelectorRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varApiPrivilegeRepositoryContentSelectorRequest := _ApiPrivilegeRepositoryContentSelectorRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApiPrivilegeRepositoryContentSelectorRequest)

	if err != nil {
		return err
	}

	*o = ApiPrivilegeRepositoryContentSelectorRequest(varApiPrivilegeRepositoryContentSelectorRequest)
