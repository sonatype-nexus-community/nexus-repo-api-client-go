...
func (r ApiList1Request) Execute() (*UserTokenListXO, *http.Response, error) {
	return r.ApiService.List1Execute(r)
}

/*
List1 List all user tokens
...
func (a *SecurityManagementUserTokensAPIService) List1Execute(r ApiList1Request) (*UserTokenListXO, *http.Response, error) {
	var (
