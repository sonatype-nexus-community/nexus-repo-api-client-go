...
// checks if the ComposerHostedRepositoryApiRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ComposerHostedRepositoryApiRequest{}

// ComposerHostedRepositoryApiRequest struct for ComposerHostedRepositoryApiRequest
type ComposerHostedRepositoryApiRequest struct {
...
type _ComposerHostedRepositoryApiRequest ComposerHostedRepositoryApiRequest
...
func NewComposerHostedRepositoryApiRequest(name string, online bool, storage HostedStorageAttributes) *ComposerHostedRepositoryApiRequest {
	this := ComposerHostedRepositoryApiRequest{}
	this.Name = name
	this.Online = online
...
func (o ComposerHostedRepositoryApiRequest) MarshalJSON() ([]byte, error) {
...
func (o ComposerHostedRepositoryApiRequest) ToMap() (map[string]interface{}, error) {
...
func (o *ComposerHostedRepositoryApiRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varComposerHostedRepositoryApiRequest := _ComposerHostedRepositoryApiRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varComposerHostedRepositoryApiRequest)

	if err != nil {
		return err
	}

	*o = ComposerHostedRepositoryApiRequest(varComposerHostedRepositoryApiRequest)

	return err
}

type NullableComposerHostedRepositoryApiRequest struct {
	value *ComposerHostedRepositoryApiRequest
	isSet bool
}

func (v NullableComposerHostedRepositoryApiRequest) Get() *ComposerHostedRepositoryApiRequest {
	return v.value
}

func (v *NullableComposerHostedRepositoryApiRequest) Set(val *ComposerHostedRepositoryApiRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableComposerHostedRepositoryApiRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableComposerHostedRepositoryApiRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComposerHostedRepositoryApiRequest(val *ComposerHostedRepositoryApiRequest) *NullableComposerHostedRepositoryApiRequest {
	return &NullableComposerHostedRepositoryApiRequest{value: val, isSet: true}
}

func (v NullableComposerHostedRepositoryApiRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComposerHostedRepositoryApiRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
