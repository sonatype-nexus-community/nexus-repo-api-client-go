...
// checks if the AnsibleGalaxyHostedRepositoryApiRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AnsibleGalaxyHostedRepositoryApiRequest{}

// AnsibleGalaxyHostedRepositoryApiRequest Request body for creating or updating an Ansible Galaxy hosted repository
type AnsibleGalaxyHostedRepositoryApiRequest struct {
...
type _AnsibleGalaxyHostedRepositoryApiRequest AnsibleGalaxyHostedRepositoryApiRequest
...
func NewAnsibleGalaxyHostedRepositoryApiRequest(name string, online bool, storage HostedStorageAttributes) *AnsibleGalaxyHostedRepositoryApiRequest {
	this := AnsibleGalaxyHostedRepositoryApiRequest{}
	this.Name = name
	this.Online = online
...
func (o AnsibleGalaxyHostedRepositoryApiRequest) MarshalJSON() ([]byte, error) {
...
func (o AnsibleGalaxyHostedRepositoryApiRequest) ToMap() (map[string]interface{}, error) {
...
func (o *AnsibleGalaxyHostedRepositoryApiRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varAnsibleGalaxyHostedRepositoryApiRequest := _AnsibleGalaxyHostedRepositoryApiRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAnsibleGalaxyHostedRepositoryApiRequest)

	if err != nil {
		return err
	}

	*o = AnsibleGalaxyHostedRepositoryApiRequest(varAnsibleGalaxyHostedRepositoryApiRequest)

	return err
}

type NullableAnsibleGalaxyHostedRepositoryApiRequest struct {
	value *AnsibleGalaxyHostedRepositoryApiRequest
	isSet bool
}

func (v NullableAnsibleGalaxyHostedRepositoryApiRequest) Get() *AnsibleGalaxyHostedRepositoryApiRequest {
	return v.value
}

func (v *NullableAnsibleGalaxyHostedRepositoryApiRequest) Set(val *AnsibleGalaxyHostedRepositoryApiRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableAnsibleGalaxyHostedRepositoryApiRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableAnsibleGalaxyHostedRepositoryApiRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAnsibleGalaxyHostedRepositoryApiRequest(val *AnsibleGalaxyHostedRepositoryApiRequest) *NullableAnsibleGalaxyHostedRepositoryApiRequest {
	return &NullableAnsibleGalaxyHostedRepositoryApiRequest{value: val, isSet: true}
}

func (v NullableAnsibleGalaxyHostedRepositoryApiRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAnsibleGalaxyHostedRepositoryApiRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
