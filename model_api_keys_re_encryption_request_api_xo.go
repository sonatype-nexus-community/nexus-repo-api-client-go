...
type ApiKeysReEncryptionRequestApiXO struct {
	...
	// Optional - The iterations to be used to decrypt the principals
	IterationsForDecryption *int32 `json:"iterationsForDecryption,omitempty"`
...
// GetIterationsForDecryption returns the IterationsForDecryption field value if set, zero value otherwise.
func (o *ApiKeysReEncryptionRequestApiXO) GetIterationsForDecryption() int32 {
	if o == nil || IsNil(o.IterationsForDecryption) {
		var ret int32
		return ret
	}
	return *o.IterationsForDecryption
}

// GetIterationsForDecryptionOk returns a tuple with the IterationsForDecryption field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ApiKeysReEncryptionRequestApiXO) GetIterationsForDecryptionOk() (*int32, bool) {
	if o == nil || IsNil(o.IterationsForDecryption) {
		return nil, false
	}
	return o.IterationsForDecryption, true
}
...
// SetIterationsForDecryption gets a reference to the given int32 and assigns it to the IterationsForDecryption field.
func (o *ApiKeysReEncryptionRequestApiXO) SetIterationsForDecryption(v int32) {
	o.IterationsForDecryption = &v
}
...
func (o ApiKeysReEncryptionRequestApiXO) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IterationsForDecryption) {
		toSerialize["iterationsForDecryption"] = o.IterationsForDecryption
	}
