...
func (r ApiRead1Request) Execute() (*ScriptXO, *http.Response, error) {
	return r.ApiService.Read1Execute(r)
}

/*
Read1 Read stored script by name

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param name
 @return ApiRead1Request
*/
func (a *ScriptAPIService) Read1(ctx context.Context, name string) ApiRead1Request {
	return ApiRead1Request{
		ApiService: a,
		ctx: ctx,
		name: name,
...
// Execute executes the request
//  @return ScriptXO
func (a *ScriptAPIService) Read1Execute(r ApiRead1Request) (*ScriptXO, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ScriptAPIService.Read1")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
