...
// checks if the RHostedApiRepository type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RHostedApiRepository{}

// RHostedApiRepository struct for RHostedApiRepository
type RHostedApiRepository struct {
...
type _RHostedApiRepository RHostedApiRepository
...
func (o RHostedApiRepository) MarshalJSON() ([]byte, error) {
...
func (o RHostedApiRepository) ToMap() (map[string]interface{}, error) {
...
func (o *RHostedApiRepository) UnmarshalJSON(data []byte) (err error) {
	...
	varRHostedApiRepository := _RHostedApiRepository{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRHostedApiRepository)

	if err != nil {
		return err
	}

	*o = RHostedApiRepository(varRHostedApiRepository)

	return err
}

type NullableRHostedApiRepository struct {
	value *RHostedApiRepository
	isSet bool
}

func (v NullableRHostedApiRepository) Get() *RHostedApiRepository {
	return v.value
}

func (v *NullableRHostedApiRepository) Set(val *RHostedApiRepository) {
	v.value = val
	v.isSet = true
}

func (v NullableRHostedApiRepository) IsSet() bool {
	return v.isSet
}

func (v *NullableRHostedApiRepository) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRHostedApiRepository(val *RHostedApiRepository) *NullableRHostedApiRepository {
	return &NullableRHostedApiRepository{value: val, isSet: true}
}

func (v NullableRHostedApiRepository) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRHostedApiRepository) UnmarshalJSON(src []byte) error {
	v.isSet = true
