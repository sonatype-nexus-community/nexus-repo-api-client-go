...
type ComponentXO struct {
	...
	ExtraJsonAttributes map[string]map[string]interface{} `json:"extraJsonAttributes,omitempty"`
...
// GetExtraJsonAttributes returns the ExtraJsonAttributes field value if set, zero value otherwise.
func (o *ComponentXO) GetExtraJsonAttributes() map[string]map[string]interface{} {
	if o == nil || IsNil(o.ExtraJsonAttributes) {
		var ret map[string]map[string]interface{}
		return ret
	}
	return o.ExtraJsonAttributes
}

// GetExtraJsonAttributesOk returns a tuple with the ExtraJsonAttributes field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ComponentXO) GetExtraJsonAttributesOk() (map[string]map[string]interface{}, bool) {
	if o == nil || IsNil(o.ExtraJsonAttributes) {
		return map[string]map[string]interface{}{}, false
	}
	return o.ExtraJsonAttributes, true
}
...
// SetExtraJsonAttributes gets a reference to the given map[string]map[string]interface{} and assigns it to the ExtraJsonAttributes field.
func (o *ComponentXO) SetExtraJsonAttributes(v map[string]map[string]interface{}) {
	o.ExtraJsonAttributes = v
}
...
func (o ComponentXO) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ExtraJsonAttributes) {
		toSerialize["extraJsonAttributes"] = o.ExtraJsonAttributes
	}
	if !IsNil(o.Format) {
