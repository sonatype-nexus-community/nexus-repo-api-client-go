...
// checks if the HuggingFaceProxyApiRepository type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HuggingFaceProxyApiRepository{}

// HuggingFaceProxyApiRepository struct for HuggingFaceProxyApiRepository
type HuggingFaceProxyApiRepository struct {
...
type _HuggingFaceProxyApiRepository HuggingFaceProxyApiRepository
...
func NewHuggingFaceProxyApiRepository(httpClient HttpClientAttributes, name string, negativeCache NegativeCacheAttributes, online bool, proxy ProxyAttributes, storage StorageAttributes, format string, type_ string, url string) *HuggingFaceProxyApiRepository {
	this := HuggingFaceProxyApiRepository{}
...
func (o HuggingFaceProxyApiRepository) MarshalJSON() ([]byte, error) {
...
func (o HuggingFaceProxyApiRepository) ToMap() (map[string]interface{}, error) {
...
func (o *HuggingFaceProxyApiRepository) UnmarshalJSON(data []byte) (err error) {
	...
	varHuggingFaceProxyApiRepository := _HuggingFaceProxyApiRepository{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varHuggingFaceProxyApiRepository)

	if err != nil {
		return err
	}

	*o = HuggingFaceProxyApiRepository(varHuggingFaceProxyApiRepository)

	return err
}

type NullableHuggingFaceProxyApiRepository struct {
	value *HuggingFaceProxyApiRepository
	isSet bool
}

func (v NullableHuggingFaceProxyApiRepository) Get() *HuggingFaceProxyApiRepository {
	return v.value
}

func (v *NullableHuggingFaceProxyApiRepository) Set(val *HuggingFaceProxyApiRepository) {
	v.value = val
	v.isSet = true
}

func (v NullableHuggingFaceProxyApiRepository) IsSet() bool {
	return v.isSet
}

func (v *NullableHuggingFaceProxyApiRepository) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHuggingFaceProxyApiRepository(val *HuggingFaceProxyApiRepository) *NullableHuggingFaceProxyApiRepository {
	return &NullableHuggingFaceProxyApiRepository{value: val, isSet: true}
}

func (v NullableHuggingFaceProxyApiRepository) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHuggingFaceProxyApiRepository) UnmarshalJSON(src []byte) error {
	v.isSet = true
