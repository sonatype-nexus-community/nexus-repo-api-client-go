...
type IqConnectionXo struct {
	...
	LicensedSolutions []LicensedSolution `json:"licensedSolutions,omitempty"`
...
// SetLicensedSolutions gets a reference to the given []LicensedSolution and assigns it to the LicensedSolutions field.
