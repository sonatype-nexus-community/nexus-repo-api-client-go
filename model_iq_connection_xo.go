...
type IqConnectionXo struct {
	...
	// Whether the connected IQ Server has Firewall enabled
	HasFirewall *bool `json:"hasFirewall,omitempty"`
	// List of licensed solutions available in the connected IQ Server
	LicensedSolutions []LicensedSolutionXO `json:"licensedSolutions,omitempty"`
...
// GetLicensedSolutions returns the LicensedSolutions field value if set, zero value otherwise.
func (o *IqConnectionXo) GetLicensedSolutions() []LicensedSolutionXO {
	if o == nil || IsNil(o.LicensedSolutions) {
		var ret []LicensedSolutionXO
		return ret
	}
	return o.LicensedSolutions
}

// GetLicensedSolutionsOk returns a tuple with the LicensedSolutions field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IqConnectionXo) GetLicensedSolutionsOk() ([]LicensedSolutionXO, bool) {
	if o == nil || IsNil(o.LicensedSolutions) {
		return nil, false
	}
	return o.LicensedSolutions, true
}
...
// SetLicensedSolutions gets a reference to the given []LicensedSolutionXO and assigns it to the LicensedSolutions field.
func (o *IqConnectionXo) SetLicensedSolutions(v []LicensedSolutionXO) {
	o.LicensedSolutions = v
}
...
func (o IqConnectionXo) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.LicensedSolutions) {
		toSerialize["licensedSolutions"] = o.LicensedSolutions
	}
	if !IsNil(o.Password) {
