...
func (r ApiGet3Request) Execute() (*ReadOnlyState, *http.Response, error) {
	return r.ApiService.Get3Execute(r)
}

/*
Get3 Get read-only state

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGet3Request
*/
func (a *ReadOnlyAPIService) Get3(ctx context.Context) ApiGet3Request {
	return ApiGet3Request{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ReadOnlyAPIService) Get3Execute(r ApiGet3Request) (*ReadOnlyState, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ReadOnlyAPIService.Get3")
	if err != nil {
