...
/*
ForceRelease Forcibly release read-only and allow changes to the database
...
/*
Freeze Prevent changes to the database
...
func (r ApiGet2Request) Execute() (*ReadOnlyState, *http.Response, error) {
	return r.ApiService.Get2Execute(r)
}

/*
Get2 Get read-only state

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGet2Request
*/
func (a *ReadOnlyAPIService) Get2(ctx context.Context) ApiGet2Request {
	return ApiGet2Request{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ReadOnlyAPIService) Get2Execute(r ApiGet2Request) (*ReadOnlyState, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ReadOnlyAPIService.Get2")
	if err != nil {
...
/*
Release Release read-only and allow changes to the database
