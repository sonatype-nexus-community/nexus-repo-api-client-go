...
// FrequencyXO Frequency of execution of the task.
type FrequencyXO struct {
	// Cron expression for the task. Only applies for \"cron\" schedule.
	CronExpression *string `json:"cronExpression,omitempty"`
	// Array with the number of the days the task must run. For \"weekly\" schedule allowed values, 1 to 7. For \"monthly\" schedule allowed values, 1 to 31, and 999 for the last day of the month.
